        ...
        <div class="container">
            <div class="row align-items-center justify-content-center">
                ...
                <div class="col-xl-12 col-lg-6 offset-lg-1 col-md-9 ps-6 text-center text-lg-start lg-ps-15px"
                    ...
                    <span
                        class="bg-solitude-blue text-uppercase fs-13 ps-25px pe-25px alt-font fw-600 text-base-color lh-40 sm-lh-55 border-radius-100px d-inline-block mb-25px">Arsip/Dokumen</span>
                    ...
                    <div class="col-lg-12 mb-8">
                        ...
                        @foreach ($arsip as $item)
                            <div class="mb-4">
                                <div
                                    class="bg-white border border-color-extra-medium-gray p-3 box-shadow-small border-radius-6px d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center">

                                    <div class="mb-2 mb-md-0 me-md-3 flex-fill">
                                        <span class="fw-600 text-dark-gray d-block">Nama Dokumen:</span>
                                        <span>{{ $item->nama_dokumen }}</span>
                                    </div>

                                    <div class="mb-2 mb-md-0 me-md-3 flex-fill">
                                        <span class="fw-600 text-dark-gray d-block">Keterangan:</span>
                                        <span>{{ $item->keterangan }}</span>
                                    </div>

                                    <div class="mb-2 mb-md-0 me-md-3 flex-fill">
                                        <span class="fw-600 text-dark-gray d-block">Tahun:</span>
