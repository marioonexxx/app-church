            ...
            <div class="row align-items-center justify-content-center extra-small-screen">
                <div class="col-12 position-relative text-center page-title-extra-large">
                    <h1 class="m-auto text-white text-shadow-double-large fw-500 ls-minus-3px xs-ls-minus-2px"
                        ...
                        Warta dan Informasi - Informasi dan Pengumuman Penting</h1>
                </div>
            ...
            <div class="row align-items-center justify-content-center">
                ...
                <div class="col-xl-12 col-lg-6 offset-lg-1 col-md-9 ps-6 text-center text-lg-start lg-ps-15px"
                    ...
                    <span
                        ...
                        dan Pengumuman</span>
                    <h3 class="fw-600 text-dark-gray ls-minus-2px alt-font sm-w-80 xs-w-100 mx-auto sm-mb-20px">Informasi
                        dan Pengumuman
                    ...
                    <div class="col-lg-12">                 
                        @foreach ($Informasi as $item)
                            <div class="mb-4">
                                <div class="bg-white border border-color-extra-medium-gray p-30px sm-p-20px box-shadow-small border-radius-6px h-100">
                                    <div class="mb-3">
