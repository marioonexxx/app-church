            ...
            <div class="row starter-main">
                <div class="col-xl-6">
                    <div class="card height-equal">
                        ...
                        <form class="form theme-form" method="POST" action="{{ route('administrator.visi.submit') }}">
                            @csrf
                            <div class="card-body custom-input">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="konten" class="editor form-control" style="min-height: 300px;">{!! old('konten', $visi->konten ?? '') !!}</textarea>
                                </div>
                            </div>
                ...
                <div class="col-xl-6">
                    <div class="card height-equal">
                        <div class="card-header">
                            <h5>Visi Tersimpan:</h5>
                        </div>
                        <div class="card-body">
                            {!! $visi->konten ?? '<em>Belum ada visi.</em>' !!}
                        </div>
                    </div>
                </div>
            </div>
