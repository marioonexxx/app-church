...
@section('title', 'Selamat Datang di Website Gereja Jemaat GPM Halong')
    ...
    <div class="page-body">
        <div class="container-fluid">
            <div class="page-title">
                <div class="row">
                    <div class="col-sm-6">
                        <h3>Dashboard Admin Pengelola Website {{ $header?->judul ?? 'Nama Gereja' }}</h3>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb">
                ...
                <div class="col-xxl-8 col-sm-6 box-col-6">
                    <div class="card profile-box">
                        <div class="card-body">
                            ...
                            <div class="cartoon"><img class="img-fluid" src="{{ asset('cuba/assets/images/dashboard/cartoon.svg') }}"
