                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-12 col-xl-6 col-lg-8 text-center position-relative page-title-double-large">
                        <div class="d-flex flex-column justify-content-center extra-very-small-screen">
                            <h1 class="text-dark-gray alt-font ls-minus-1px fw-700">Blog masonry</h1>
                        ...
                        <ul class="blog-masonry blog-wrapper grid-loading grid grid-4col xl-grid-4col lg-grid-3col md-grid-2col sm-grid-2col xs-grid-1col gutter-extra-large">
                            ...
                            <li class="grid-item">
                                <div class="card border-0 border-radius-4px overflow-hidden box-shadow-quadruple-large box-shadow-quadruple-large-hover">
                                    <div class="card-top d-flex align-items-center">
                                        <a href="blog-simple.html"><img src="https://placehold.co/125x125" class="avtar" alt=""></a>
                                        <span class="fs-15">By <a href="blog-simple.html" class="text-dark-gray text-dark-gray-hover fw-600">Andy glamer</a></span>
                                        <div class="like-count ms-auto fs-13">
                                            <a href="demo-blogger-blog-single-classic.html"><i class="fa-regular fa-heart text-red d-inline-block"></i><span class="text-dark-gray fw-600">65</span></a>
                                        </div>
                                    </div>
                                    <div class="blog-image position-relative overflow-hidden">
                                        <a href="demo-blogger-blog-single-classic.html"><img src="https://placehold.co/800x850" alt="" /></a>
                                        <div class="blog-categories">
                                            <a href="blog-simple.html" class="categories-btn bg-white text-dark-gray text-dark-gray-hover text-uppercase alt-font fw-600">Agency</a>
                                        </div>
                                    </div>
                                    <div class="card-body p-0">
                                        <div class="post-content ps-13 pe-13 pt-11 pb-11">
                                            <a href="demo-blogger-blog-single-classic.html" class="card-title mb-10px fw-500 fs-17 lh-26 fw-600 text-dark-gray text-dark-gray-hover d-inline-block">It takes a real designer to design for real women.</a>
                                            <p class="mb-10px">Lorem ipsum has been industry standard dummy text ever...</p>
                                            <a href="blog-simple.html" class="blog-date fs-14 text-medium-gray text-dark-gray-hover"><i class="feather icon-feather-calendar text-dark-gray fs-15"></i>30 August 2023</a>
                                        </div>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li class="grid-item">
                                <div class="card border-0 border-radius-4px overflow-hidden box-shadow-quadruple-large box-shadow-quadruple-large-hover">
                                    <div class="card-top d-flex align-items-center">
                                        <a href="blog-simple.html"><img src="https://placehold.co/125x125" class="avtar" alt=""></a>
                                        <span class="fs-15">By <a href="blog-simple.html" class="text-dark-gray text-dark-gray-hover fw-600">Den viliamson</a></span>
                                        <div class="like-count ms-auto fs-13">
                                            <a href="demo-blogger-blog-single-classic.html"><i class="fa-regular fa-heart text-red d-inline-block"></i><span class="text-dark-gray fw-600">35</span></a>
                                        </div>
                                    </div>
                                    <div class="blog-image position-relative overflow-hidden">
                                        <a href="demo-blogger-blog-single-classic.html"><img src="https://placehold.co/800x580" alt="" /></a>
                                        <div class="blog-categories">
                                            <a href="blog-simple.html" class="categories-btn bg-white text-dark-gray text-dark-gray-hover text-uppercase alt-font fw-600">Design</a>
                                        </div>
                                    </div>
                                    <div class="card-body p-0">
                                        <div class="post-content ps-13 pe-13 pt-11 pb-11">
                                            <a href="demo-blogger-blog-single-classic.html" class="card-title mb-10px fw-500 fs-17 lh-26 fw-600 text-dark-gray text-dark-gray-hover d-inline-block">Experience the breathtaking views and perspectives.</a>
                                            <p class="mb-15px">Lorem ipsum has been industry standard dummy text ever...</p>
                                            <a href="blog-simple.html" class="blog-date fs-14 text-medium-gray text-dark-gray-hover"><i class="feather icon-feather-calendar text-dark-gray fs-15"></i>28 August 2023</a>
                                        </div>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li class="grid-item">
                                <div class="card border-0 border-radius-4px overflow-hidden box-shadow-quadruple-large box-shadow-quadruple-large-hover">
                                    <div class="card-top d-flex align-items-center">
                                        <a href="blog-simple.html"><img src="https://placehold.co/125x125" class="avtar" alt=""></a>
                                        <span class="fs-15">By <a href="blog-simple.html" class="text-dark-gray text-dark-gray-hover fw-600">Jones robbert</a></span>
                                        <div class="like-count ms-auto fs-13">
                                            <a href="demo-blogger-blog-single-classic.html"><i class="fa-regular fa-heart text-red d-inline-block"></i><span class="text-dark-gray fw-600">58</span></a>
                                        </div>
                                    </div>
                                    <div class="blog-image position-relative overflow-hidden">
                                        <a href="demo-blogger-blog-single-classic.html"><img src="https://placehold.co/800x850" alt="" /></a>
                                        <div class="blog-categories">
                                            <a href="blog-simple.html" class="categories-btn bg-white text-dark-gray text-dark-gray-hover text-uppercase alt-font fw-600">Branding</a>
                                        </div>
                                    </div>
                                    <div class="card-body p-0">
                                        <div class="post-content ps-13 pe-13 pt-11 pb-11">
                                            <a href="demo-blogger-blog-single-classic.html" class="card-title mb-10px fw-500 fs-17 lh-26 fw-600 text-dark-gray text-dark-gray-hover d-inline-block">Build up healthy habits and strong peaceful life.</a>
                                            <p class="mb-15px">Lorem ipsum has been industry standard dummy text ever...</p>
                                            <a href="blog-simple.html" class="blog-date fs-14 text-medium-gray text-dark-gray-hover"><i class="feather icon-feather-calendar text-dark-gray fs-15"></i>26 August 2023</a>
                                        </div>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li class="grid-item">
                                <div class="card border-0 border-radius-4px overflow-hidden box-shadow-quadruple-large box-shadow-quadruple-large-hover">
                                    <div class="card-top d-flex align-items-center">
                                        ...
                                        <span class="fs-15">By <a href="blog-simple.html" class="text-dark-gray text-dark-gray-hover fw-600">Andy glamer</a></span>
                                        <div class="like-count ms-auto fs-13">
                                            <a href="demo-blogger-blog-single-classic.html"><i class="fa-regular fa-heart text-red d-inline-block"></i><span class="text-dark-gray fw-600">25</span></a>
                                        </div>
                                    </div>
                                    <div class="blog-image position-relative overflow-hidden">
                                        <a href="demo-blogger-blog-single-classic.html"><img src="https://placehold.co/800x580" alt="" /></a>
                                    ...
                                    <div class="card-body p-0">
                                        <div class="post-content ps-13 pe-13 pt-11 pb-11">
                                            <a href="demo-blogger-blog-single-classic.html" class="card-title mb-10px fw-500 fs-17 lh-26 fw-600 text-dark-gray text-dark-gray-hover d-inline-block">Some people just try to celebrate the joys of life.</a>
                                            <p class="mb-15px">Lorem ipsum has been industry standard dummy text ever...</p>
                                            <a href="blog-simple.html" class="blog-date fs-14 text-medium-gray text-dark-gray-hover"><i class="feather icon-feather-calendar text-dark-gray fs-15"></i>24 August 2023</a>
                                        </div>
                                    </div>
                                </div>
                            </li>         
                            ...
                            <li class="grid-item">
                                ...
                                <div class="card border-0 border-radius-4px overflow-hidden box-shadow-quadruple-large box-shadow-quadruple-large-hover">
                                    <div class="card-top d-flex align-items-center">
                                        <a href="blog-simple.html"><img src="https://placehold.co/125x125" class="avtar" alt=""></a>
                                        <span class="fs-15">By <a href="blog-simple.html" class="text-dark-gray text-dark-gray-hover fw-600">Rosald smith</a></span>
                                        <div class="like-count ms-auto fs-13">
                                            <a href="demo-blogger-blog-single-classic.html"><i class="fa-regular fa-heart text-red d-inline-block"></i><span class="text-dark-gray fw-600">45</span></a>
                                        </div>
                                    </div>
                                    <div class="blog-image position-relative overflow-hidden">
                                        <a href="demo-blogger-blog-single-classic.html"><img src="https://placehold.co/800x850" alt="" /></a>
                                        <div class="blog-categories">
                                            <a href="blog-simple.html" class="categories-btn bg-white text-dark-gray text-dark-gray-hover text-uppercase alt-font fw-600">Luxurious</a>
                                        </div>
                                    </div>
                                    <div class="card-body p-0">
                                        <div class="post-content ps-13 pe-13 pt-11 pb-11">
                                            <a href="demo-blogger-blog-single-classic.html" class="card-title mb-10px fw-500 fs-17 lh-26 fw-600 text-dark-gray text-dark-gray-hover d-inline-block">Teamwork is essential for small teams to challenges.</a>
                                            <p class="mb-15px">Lorem ipsum has been industry standard dummy text ever...</p>
                                            <a href="blog-simple.html" class="blog-date fs-14 text-medium-gray text-dark-gray-hover"><i class="feather icon-feather-calendar text-dark-gray fs-15"></i>22 August 2023</a>
                                        </div>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li class="grid-item">
                                <div class="card border-0 border-radius-4px overflow-hidden box-shadow-quadruple-large box-shadow-quadruple-large-hover">
                                    <div class="card-top d-flex align-items-center">
                                        <a href="blog-simple.html"><img src="https://placehold.co/150x150" class="avtar" alt=""></a>
                                        <span class="fs-15">By <a href="blog-simple.html" class="text-dark-gray text-dark-gray-hover fw-600">Andy glamer</a></span>
                                        <div class="like-count ms-auto fs-13">
                                            <a href="demo-blogger-blog-single-classic.html"><i class="fa-regular fa-heart text-red d-inline-block"></i><span class="text-dark-gray fw-600">23</span></a>
                                        </div>
                                    </div>
                                    <div class="blog-image position-relative overflow-hidden">
                                        <a href="demo-blogger-blog-single-classic.html"><img src="https://placehold.co/800x850" alt="" /></a>
                                        <div class="blog-categories">
                                            <a href="blog-simple.html" class="categories-btn bg-white text-dark-gray text-dark-gray-hover text-uppercase alt-font fw-600">Adventure</a>
                                        </div>
                                    </div>
                                    <div class="card-body p-0">
                                        <div class="post-content ps-13 pe-13 pt-11 pb-11">
                                            <a href="demo-blogger-blog-single-classic.html" class="card-title mb-10px fw-500 fs-17 lh-26 fw-600 text-dark-gray text-dark-gray-hover d-inline-block">A business needs a successful mix of design.</a>
                                            <p class="mb-15px">Lorem ipsum has been industry standard dummy text ever...</p>
                                            <a href="blog-simple.html" class="blog-date fs-14 text-medium-gray text-dark-gray-hover"><i class="feather icon-feather-calendar text-dark-gray fs-15"></i>20 August 2023</a>
                                        </div>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li class="grid-item">
                                <div class="card border-0 border-radius-4px overflow-hidden box-shadow-quadruple-large box-shadow-quadruple-large-hover">
                                    ...
                                    <div class="card-body p-0">
                                        <div class="post-content ps-13 pe-13 pt-11 pb-11">
                                            <a href="demo-blogger-blog-single-classic.html" class="card-title mb-10px fw-500 fs-17 lh-26 fw-600 text-dark-gray text-dark-gray-hover d-inline-block">No matter what you're feeling or experiencing.</a>
                                            <p class="mb-15px">Lorem ipsum has been industry standard dummy text ever...</p>
                                            <a href="blog-simple.html" class="blog-date fs-14 text-medium-gray text-dark-gray-hover"><i class="feather icon-feather-calendar text-dark-gray fs-15"></i>18 August 2023</a>
                                        </div>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li class="grid-item">
                                <div class="card border-0 border-radius-4px overflow-hidden box-shadow-quadruple-large box-shadow-quadruple-large-hover">
                                    ...
                                    <div class="card-body p-0">
                                        <div class="post-content ps-13 pe-13 pt-11 pb-11">
                                            <a href="demo-blogger-blog-single-classic.html" class="card-title mb-10px fw-500 fs-17 lh-26 fw-600 text-dark-gray text-dark-gray-hover d-inline-block">Many focus on embracing what they can control.</a>
                                            <p class="mb-15px">Lorem ipsum has been industry standard dummy text ever...</p>
                                            <a href="blog-simple.html" class="blog-date fs-14 text-medium-gray text-dark-gray-hover"><i class="feather icon-feather-calendar text-dark-gray fs-15"></i>16 August 2023</a>
                                        </div>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li class="grid-item">
                                <div class="card border-0 border-radius-4px overflow-hidden box-shadow-quadruple-large box-shadow-quadruple-large-hover">
                                    ...
                                    <div class="card-body p-0">
                                        <div class="post-content ps-13 pe-13 pt-11 pb-11">
                                            <a href="demo-blogger-blog-single-classic.html" class="card-title mb-10px fw-500 fs-17 lh-26 fw-600 text-dark-gray text-dark-gray-hover d-inline-block">The pessimist sees difficulty in every opportunity.</a>
                                            <p class="mb-15px">Lorem ipsum has been industry standard dummy text ever...</p>
                                            <a href="blog-simple.html" class="blog-date fs-14 text-medium-gray text-dark-gray-hover"><i class="feather icon-feather-calendar text-dark-gray fs-15"></i>14 August 2023</a>
                                        </div>
                                    </div>
                                </div>
                            </li>
                                ...
                                <div class="card border-0 border-radius-4px overflow-hidden box-shadow-quadruple-large box-shadow-quadruple-large-hover">
                                    ...
                                    <div class="card-body p-0">
                                        <div class="post-content ps-13 pe-13 pt-11 pb-11">
                                            <a href="demo-blogger-blog-single-classic.html" class="card-title mb-10px fw-500 fs-17 lh-26 fw-600 text-dark-gray text-dark-gray-hover d-inline-block">It takes a real designer to design for real women.</a>
                                            <p class="mb-15px">Lorem ipsum has been industry standard dummy text ever...</p>
                                            <a href="blog-simple.html" class="blog-date fs-14 text-medium-gray text-dark-gray-hover"><i class="feather icon-feather-calendar text-dark-gray fs-15"></i>12 August 2023</a>
                                        </div>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li class="grid-item">
                                <div class="card border-0 border-radius-4px overflow-hidden box-shadow-quadruple-large box-shadow-quadruple-large-hover">
                                    ...
                                    <div class="card-body p-0">
                                        <div class="post-content ps-13 pe-13 pt-11 pb-11">
                                            <a href="demo-blogger-blog-single-classic.html" class="card-title mb-10px fw-500 fs-17 lh-26 fw-600 text-dark-gray text-dark-gray-hover d-inline-block">Sometimes we're tested not to show our weaknesses.</a>
                                            <p class="mb-15px">Lorem ipsum has been industry standard dummy text ever...</p>
                                            <a href="blog-simple.html" class="blog-date fs-14 text-medium-gray text-dark-gray-hover"><i class="feather icon-feather-calendar text-dark-gray fs-15"></i>10 August 2023</a>
                                        </div>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li class="grid-item">
                                <div class="card border-0 border-radius-4px overflow-hidden box-shadow-quadruple-large box-shadow-quadruple-large-hover">
                                    ...
                                    <div class="card-body p-0">
                                        <div class="post-content ps-13 pe-13 pt-11 pb-11">
                                            <a href="demo-blogger-blog-single-classic.html" class="card-title mb-10px fw-500 fs-17 lh-26 fw-600 text-dark-gray text-dark-gray-hover d-inline-block">Good design is obvious great design transparent.</a>
                                            <p class="mb-15px">Lorem ipsum has been industry standard dummy text ever...</p>
                                            <a href="blog-simple.html" class="blog-date fs-14 text-medium-gray text-dark-gray-hover"><i class="feather icon-feather-calendar text-dark-gray fs-15"></i>08 August 2023</a>
                                        </div>
                                    </div>
                                </div>
                            </li>
