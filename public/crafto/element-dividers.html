...
<html class="no-js" lang="en">
    ...
    <body data-mobile-nav-style="classic">
                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-12 col-xl-6 col-lg-8 text-center position-relative page-title-double-large">
                        <div class="d-flex flex-column justify-content-center extra-very-small-screen">
                            <h1 class="text-dark-gray alt-font ls-minus-1px fw-700 mb-20px">Dividers</h1>
                            <h2 class="text-dark-gray d-inline-block fw-400 ls-0px mb-0">Creates visual separation between content sections, enhancing page structure for improved readability and aesthetics.</h2> 
                        </div>
        ...
        <section class="bg-very-light-gray">
            <div class="container">
                <div class="row justify-content-center mb-50px sm-mb-20px">
                    <div class="col-xl-6 col-lg-7 col-md-9">
                        <h6 class="text-dark-gray fw-600 mb-20px">Standard divider</h6>
                        <div class="divider-style-03 divider-style-03-01 border-color-dark-gray mb-20px mt-20px w-100"></div>
                        <p>Lorem ipsum is simply dummy text of the printing typesetting lorem ipsum been text. Lorem ipsum is simply dummy text of the printing typesetting lorem ipsum been text.</p>
                    </div>
                </div>
                <div class="row justify-content-center mb-50px sm-mb-20px">
                    <div class="col-xl-6 col-lg-7 col-md-9">
                        <h6 class="text-dark-gray fw-600 mb-20px">Dashed divider</h6>
                        <div class="divider-style-03 divider-style-03-02 border-color-dark-gray mb-20px mt-20px w-100"></div>
                        <p>Lorem ipsum is simply dummy text of the printing typesetting lorem ipsum been text. Lorem ipsum is simply dummy text of the printing typesetting lorem ipsum been text.</p>
                    </div>
                </div>
                <div class="row justify-content-center mb-50px sm-mb-20px">
                    <div class="col-xl-6 col-lg-7 col-md-9">
                        <h6 class="text-dark-gray fw-600 mb-20px">Double line divider</h6>
                        <div class="divider-style-03 divider-style-03-03 border-color-dark-gray mb-20px mt-20px w-100"></div>
                        <p>Lorem ipsum is simply dummy text of the printing typesetting lorem ipsum been text. Lorem ipsum is simply dummy text of the printing typesetting lorem ipsum been text.</p>
                    </div>
                </div>
                <div class="row justify-content-center mb-50px sm-mb-20px">
                    <div class="col-xl-6 col-lg-7 col-md-9">
                        <h6 class="text-dark-gray fw-600 mb-20px">Dashed divider</h6>
                        <div class="divider-style-03 divider-style-03-04 border-1 border-color-dark-gray mb-20px mt-20px w-100"></div>
                        <p>Lorem ipsum is simply dummy text of the printing typesetting lorem ipsum been text. Lorem ipsum is simply dummy text of the printing typesetting lorem ipsum been text.</p>
                    </div>
                </div>
                <div class="row justify-content-center">
                    <div class="col-xl-6 col-lg-7 col-md-9">
                        <h6 class="text-dark-gray fw-600 mb-20px">Dotted divider</h6>
                        <div class="divider-style-03 divider-style-03-05 border-1 border-color-dark-gray mb-20px mt-20px w-100"></div>
                        <p>Lorem ipsum is simply dummy text of the printing typesetting lorem ipsum been text. Lorem ipsum is simply dummy text of the printing typesetting lorem ipsum been text.</p>
                    </div>
                </div>
            </div>
        ...
        <section class="big-section">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-5 text-center md-mb-50px" data-anime='{ "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 150, "easing": "easeOutQuad" }'>
                        <img src="https://placehold.co/455x466" class="animation-float" alt="">
                    </div>
                    <div class="col-lg-2 divider-style-02 d-none d-lg-block ">
                    ...
                    <div class="col-lg-5 text-center text-lg-start" data-anime='{ "el": "childs", "willchange": "transform", "opacity": [0, 1], "rotateY": [-90, 0], "rotateZ": [-10, 0], "translateY": [80, 0], "translateZ": [50, 0], "staggervalue": 200, "duration": 600, "delay": 100, "easing": "easeOutCirc" }'>
                        <span class="ps-20px pe-20px mb-30px md-mb-20px text-uppercase text-dark-gray fs-13 lh-40 md-lh-50 ls-1px alt-font fw-700 border-radius-4px bg-solitude-blue d-inline-block">Optimize your website</span>
                        <h2 class="text-dark-gray fw-600 ls-minus-1px mb-20px">How do you get top ranks in seo?</h2>
                        <p>We are committed to deliver unique digital media solutions from web development to eCommerce solutions for our happy clients by using our knowledge and expertise.</p>
                        <a href="#" class="btn btn-dark-gray btn-round-edge btn-medium btn-box-shadow mt-10px">Learn more</a>
                    </div>
                </div>
            </div>
        </section>
