...
<html class="no-js" lang="en">
    ...
    <body data-mobile-nav-style="classic">
                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-12 col-xl-6 col-lg-8 text-center position-relative page-title-double-large">
                        <div class="d-flex flex-column justify-content-center extra-very-small-screen">
                            <h1 class="text-dark-gray alt-font ls-minus-1px fw-700 mb-20px">Counters</h1>
                            <h2 class="text-dark-gray d-inline-block fw-400 ls-0px mb-0">Animate and showcase statistic data creatively with the counters. Customize styles and settings for a unique touch.</h2> 
                        </div>
        ...
        <section class="bg-gradient-top-very-light-gray big-section pt-0">
            <div class="container">
                <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-4 justify-content-center counter-style-01">
                    ...
                    <div class="col feature-box md-mb-50px xs-mb-30px">
                        <div class="feature-box-icon">
                            <i class="ti-alarm-clock icon-large text-dark-gray mb-20px d-block"></i>
                        </div>
                        <div class="feature-box-content">
                            <h2 class="d-inline-block align-middle counter-number fw-700 text-dark-gray mb-0 counter" data-speed="2000" data-to="3200"></h2>
                            <span class="d-block text-dark-gray fw-500">Hours spent</span> 
                        </div>
                    </div>
                    <!-- end counter item -->                    
                    <!-- start counter item -->
                    <div class="col feature-box xs-mb-30px">
                        <div class="feature-box-icon">
                            <i class="ti-world icon-large text-dark-gray mb-20px d-block"></i>
                        </div>
                        <div class="feature-box-content">
                            <h2 class="d-inline-block align-middle counter-number fw-700 text-dark-gray mb-0 counter" data-speed="2000" data-to="2545"></h2>
                            <span class="d-block text-dark-gray fw-500">Work completed</span>
                        </div>                        
                    </div>
                    <!-- end counter item -->                    
                    <!-- start counter item -->
                    <div class="col feature-box">
                        <div class="feature-box-icon">
                            <i class="ti-headphone-alt icon-large text-dark-gray mb-20px d-block"></i>
                        </div>
                        <div class="feature-box-content last-paragraph-no-margin">
                            <h2 class="d-inline-block align-middle counter-number fw-700 text-dark-gray mb-0 counter" data-speed="2000" data-to="3650"></h2>
                            <span class="d-block text-dark-gray fw-500">Telephonic talk</span> 
                        </div>
                    </div>                        
                    <!-- end counter item -->                    
                </div>
            ...
            <div class="container">
                <div class="row row-cols-1 row-cols-lg-4 row-cols-sm-2 justify-content-center counter-style-02">
                    ...
                    <div class="col text-center md-mb-50px xs-mb-30px">
                        <h1 class="vertical-counter d-inline-flex text-dark-gray fw-700 mb-0 ls-minus-4px md-ls-minus-2px" data-to="6351"></h1>
                        <span class="d-block text-dark-gray fw-500 fs-18">Active users</span>
                    </div>
                    <!-- end counter item -->                    
                    <!-- start counter item -->
                    <div class="col text-center md-mb-50px xs-mb-30px">
                        <h1 class="vertical-counter d-inline-flex text-dark-gray fw-700 mb-0 ls-minus-4px md-ls-minus-2px" data-to="5298"></h1>
                        <span class="d-block text-dark-gray fw-500 fs-18">New installation</span>
                    </div>
                    <!-- end counter item -->                    
                    <!-- start counter item -->
                    <div class="col text-center xs-mb-30px">
                        <h1 class="vertical-counter d-inline-flex text-dark-gray fw-700 mb-0 ls-minus-4px md-ls-minus-2px" data-to="5864"></h1>
                        <span class="d-block text-dark-gray fw-500 fs-18">User reviews</span>
                    </div>
                    <!-- end counter item -->                    
                    <!-- start counter item -->
                    <div class="col text-center">
                        <h1 class="vertical-counter d-inline-flex text-dark-gray fw-700 mb-0 ls-minus-4px md-ls-minus-2px" data-to="7452"></h1>
                        <span class="d-block text-dark-gray fw-500 fs-18">Telephonic talk</span>
                    </div>
                    <!-- end counter item -->                    
                </div>
            </div>
        ...
        <!-- end section -->
        <!-- start section -->
        <section class="fix-background big-section background-position-center-top" style="background-image: url(https://placehold.co/1920x1100)">
            <div class="opacity-medium bg-black"></div>
            <div class="container position-relative">
                <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-4 counter-style-03">
                    <!-- start counter item -->
                    <div class="col feature-box md-mb-50px xs-mb-30px">
                        <div class="feature-box-icon mb-15px">
                            <i class="line-icon-Add-User icon-extra-large text-yellow"></i>
                        </div>
                        <div class="feature-box-content">
                            <div class="fs-22 d-block text-white alt-font"><span class="d-inline-block w-40px counter fw-600" data-speed="2000" data-to="70"></span>- Director</div>
                        </div>
                    </div>
                    <!-- end counter item -->
                    <!-- start counter item -->
                    <div class="col feature-box md-mb-50px xs-mb-30px">
                        <div class="feature-box-icon mb-15px">
                            <i class="line-icon-Love-User icon-extra-large text-yellow"></i>
                        </div>
                        <div class="feature-box-content">
                            <div class="fs-22 d-block text-white alt-font"><span class="d-inline-block w-40px counter fw-600" data-speed="2000" data-to="36"></span>- Designer</div>
                        </div>
                    </div>
                    <!-- end counter item -->
                    <!-- start counter item -->
                    <div class="col feature-box xs-mb-30px">
                        <div class="feature-box-icon mb-15px">
                            <i class="line-icon-Find-User icon-extra-large text-yellow"></i>
                        </div>
                        <div class="feature-box-content">
                            <div class="fs-22 d-block text-white alt-font"><span class="d-inline-block w-40px counter fw-600" data-speed="2000" data-to="44"></span>- Developer</div>
                        </div>
                    </div>
                    <!-- end counter item -->
                    <!-- start counter item -->
                    <div class="col feature-box">
                        <div class="feature-box-icon mb-15px">
                            <i class="line-icon-Checked-User icon-extra-large text-yellow"></i>
                        </div>
                        <div class="feature-box-content">
                            <div class="fs-22 d-block text-white alt-font"><span class="d-inline-block w-40px counter fw-600" data-speed="2000" data-to="64"></span>- Animator</div>
                        </div>
                    </div>
                    <!-- end counter item -->
                </div>
        ...
        <!-- end section -->      
        <!-- start section -->
        <section class="big-section overflow-hidden">
            <div class="container">
                <div class="row mb-6 sm-mb-50px">
                    <div class="col-md-12 text-center text-md-start" data-anime='{"opacity": [0,1], "duration": 600, "delay":0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                        <div class="fs-140 xxl-fs-100 sm-fs-60 fw-600 text-dark-gray alt-font ls-minus-6px sm-ls-minus-2px" data-bottom-top="transform: translate3d(-50px, 0px, 0px);" data-top-bottom="transform: translate3d(50px, 0px, 0px);">Brand experience</div>
                    </div>
                    <div class="col-12">
                        <div class="row align-items-center align-items-lg-end" data-bottom-top="transform: translate3d(-30px, 0px, 0px);" data-top-bottom="transform: translate3d(30px, 0px, 0px);">
                            <div class="col-lg-3 col-md-4 text-md-end text-center md-mt-30px md-mb-20px" data-anime='{"opacity": [0,1], "duration": 600, "delay":0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                                <div class="position-relative">
                                    <img src="images/demo-branding-agency-about-01.png" class="animation-rotation" alt="">
                                    <div class="absolute-middle-center w-100 z-index-minus-1"><img src="images/demo-branding-agency-about-02.png" alt=""></div> 
                                </div>
                            </div>
                            <div class="col-lg-5 col-md-6 text-center text-md-start" data-anime='{"opacity": [0,1], "duration": 600, "delay":0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                                <div class="fs-140 xxl-fs-100 sm-fs-60 fw-600 text-dark-gray alt-font ls-minus-6px sm-ls-minus-2px">agency</div>
                            </div>
                ...
                <div class="row g-0 counter-style-04" data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay":0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                    <div class="col-lg-3 col-md-6 feature-box text-start hover-box border-start sm-border border-color-extra-medium-gray ps-35px pe-35px pt-25px pb-25px lg-ps-25px lg-pe-25px md-ps-35px md-pe-35px md-mb-50px sm-mb-30px">
                        <div class="feature-box-content">
                            ...
                            <h2 class="vertical-counter d-inline-flex text-dark-gray fw-700 ls-minus-2px mt-25 mb-0 ls-minus-1px" data-text="+" data-to="8500"><sup class="text-jade top-0"><i class="feather icon-feather-arrow-up icon-extra-medium"></i></sup></h2>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 feature-box text-start hover-box border-start sm-border border-color-extra-medium-gray md-border-end ps-35px pe-35px pt-25px pb-25px lg-ps-25px lg-pe-25px md-mb-50px sm-mb-30px">
                        <div class="feature-box-content">
                            ...
                            <h2 class="vertical-counter d-inline-flex text-dark-gray fw-700 ls-minus-2px mt-25 mb-0 ls-minus-1px" data-text="+" data-to="660"><sup class="text-jade top-0"><i class="feather icon-feather-arrow-up icon-extra-medium"></i></sup></h2>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 feature-box text-start hover-box border-start sm-border border-color-extra-medium-gray ps-35px pe-35px pt-25px pb-25px lg-ps-25px lg-pe-25px sm-mb-30px">
                        <div class="feature-box-content">
                            ...
                            <h2 class="vertical-counter d-inline-flex text-dark-gray fw-700 ls-minus-2px mt-25 mb-0 ls-minus-1px" data-text="+" data-to="6834"><sup class="text-jade top-0"><i class="feather icon-feather-arrow-up icon-extra-medium"></i></sup></h2>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 feature-box text-start hover-box border-start sm-border border-color-extra-medium-gray md-border-end ps-35px pe-35px pt-25px pb-25px lg-ps-25px lg-pe-25px">
                        <div class="feature-box-content">
                            ...
                            <h2 class="vertical-counter d-inline-flex text-dark-gray fw-700 ls-minus-2px mt-25 mb-0 ls-minus-1px" data-text="%" data-to="38"><sup class="text-jade top-0"><i class="feather icon-feather-arrow-up icon-extra-medium"></i></sup></h2>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row row-cols-1 row-cols-lg-4 row-cols-sm-2 counter-style-05">
                    ...
                    <div class="col transition-inner-all xs-mb-30px">
                        <div class="feature-box overflow-hidden hover-box dark-hover bg-white box-shadow-quadruple-large box-shadow-quadruple-large-hover border-radius-8px p-35px lg-p-25px">
                            <div class="feature-box-content">
                                <h2 class="fw-700 text-dark-gray ls-minus-1px mb-0 counter" data-speed="2000" data-to="5632"></h2>
                                <span class="d-block text-dark-gray text-light-opacity fw-600 text-uppercase fs-13 ls-1px">Capture</span>
                            </div>
                            <div class="feature-box-overlay bg-gradient-fast-blue-purple"></div>
                        </div>
                    </div>
                    ...
                    <div class="col transition-inner-all">
                        <div class="feature-box overflow-hidden hover-box dark-hover bg-white box-shadow-quadruple-large box-shadow-quadruple-large-hover border-radius-8px p-35px lg-p-25px">
                            <div class="feature-box-content">
                                <h2 class="fw-700 text-dark-gray ls-minus-1px mb-0 counter" data-speed="2000" data-to="6843"></h2>
                                <span class="d-block text-dark-gray text-light-opacity fw-600 text-uppercase fs-13 ls-1px">Coffee</span>
                            </div>
                            <div class="feature-box-overlay bg-gradient-fast-blue-purple"></div>
                        </div>
                    </div>
        ...
        <section class="big-section">
            <div class="container">
                <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-4 justify-content-center counter-style-06" data-anime='{ "el": "childs", "translateX": [-50, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 100, "easing": "easeOutQuad" }'>
                    <!-- start counter item -->
                    <div class="col feature-box md-mb-50px xs-mb-30px">
                        <div class="feature-box-content">
                            <div class="counter-number text-yellow counter fs-120 fw-700 ls-minus-3px" data-speed="2000" data-to="98"></div>
                    ...
                    <div class="col feature-box md-mb-50px xs-mb-30px"> 
                        <div class="feature-box-content">
                            <div class="counter-number text-yellow counter fs-120 fw-700 ls-minus-3px" data-speed="2000" data-to="56"></div>
                    ...
                    <div class="col feature-box xs-mb-30px"> 
                        <div class="feature-box-content">
                            <div class="counter-number text-yellow counter fs-120 fw-700 ls-minus-3px" data-speed="2000" data-to="63"></div>
                    ...
                    <div class="col feature-box"> 
                        <div class="feature-box-content last-paragraph-no-margin">
                            <div class="counter-number text-yellow counter fs-120 fw-700 ls-minus-3px" data-speed="2000" data-to="48"></div>
        ...
        <!-- end section -->
        <!-- start section -->
        <section class="border-color-extra-medium-gray border-top">
            <div class="container">
                <div class="row row-cols-1 row-cols-lg-4 row-cols-sm-2 justify-content-center counter-style-07" data-anime='{ "el": "childs", "translateY": [50, 0], "opacity": [0,1], "duration": 1200, "delay": 0, "staggervalue": 150, "easing": "easeOutQuad" }'>
                    ...
                    <div class="col text-center md-mb-50px xs-mb-30px">
                        <h2 class="vertical-counter d-inline-flex text-dark-gray fw-800 mb-0 ls-minus-3px position-relative z-index-0" data-to="4586">
                            <span class="text-highlight position-absolute bottom-13px w-100"><span class="bg-jade h-10px opacity-8"></span></span>
                        </h2>
                    ...
                    <div class="col text-center xs-mb-30px">
                        ...
                        <span class="d-block fs-14 fw-700 text-uppercase text-dark-gray">Coffee cups</span>
                    </div>
                    <!-- end counter item -->
                    <!-- start counter item -->
                    <div class="col text-center">
