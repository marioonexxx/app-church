    ...
    <body data-mobile-nav-style="classic">
                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-12 col-xl-6 col-lg-8 text-center position-relative page-title-double-large">
                        <div class="d-flex flex-column justify-content-center extra-very-small-screen">
                            <h1 class="text-dark-gray alt-font ls-minus-1px fw-700 mb-20px">Dropcaps</h1>
                            <h2 class="text-dark-gray d-inline-block fw-400 ls-0px mb-0">Capture attention with a prominent initial letter. Customize color, content, and more for added appeal with dropcaps.</h2> 
                        </div>
            ...
            <div class="container">
                ...
                <div class="row justify-content-center align-items-center">
                    ...
                    <div class="col-12 col-lg-5 col-md-6 offset-lg-1 dropcap-style-01 last-paragraph-no-margin">
                        <p><span class="first-letter text-dark-gray fw-700">M</span>Lorem ipsum is simply dummy text of the printing and typesetting industry. It has survived not only five centuries. Simply dummy text of the printing and typesetting industry. Lorem ipsum dolor amet consectetur adipiscing elit sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
        ...
        <section>
            <div class="container">
                ...
                <div class="row justify-content-center align-items-center">
                    ...
                    <div class="col-12 col-lg-5 col-md-6 offset-lg-1 dropcap-style-03 last-paragraph-no-margin">
                        <p><span class="fw-700 first-letter first-letter-block border border-2 border-color-light-medium-gray text-dark-gray border-radius-6px">N</span>Lorem ipsum is simply dummy text of the printing and typesetting industry. It has survived not only five centuries. Simply dummy text of the printing and typesetting industry. Lorem ipsum dolor amet consectetur adipiscing elit sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                        <p>It has survived only five centuries. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                    </div>
                </div> 
                <!-- end dropcaps item -->
        ...
        <section class="bg-very-light-gray">
            <div class="container">
                <!-- start dropcaps item -->
                <div class="row justify-content-center align-items-center"> 
                    <div class="col-12 col-lg-5 col-md-6 dropcap-style-04 last-paragraph-no-margin sm-mb-30px">
                        <p><span class="fw-800 first-letter first-letter-block first-letter-round bg-white box-shadow-extra-large text-dark-gray">N</span>Lorem ipsum is simply dummy text of the printing and typesetting industry. It has survived not only five centuries. Simply dummy text of the printing and typesetting industry. Lorem ipsum dolor amet consectetur adipiscing elit sed do eiusmod tempor labore dolore magna aliqua.</p>
                        <p>It has survived only five centuries. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                    </div>
                    <div class="col-12 col-md-6 offset-lg-1">
                        <img src="https://placehold.co/600x505" alt="" class="w-100 border-radius-6px">
        ...
        <!-- end section -->
        <!-- start section -->
        <section class="position-relative fix-background" style="background-image: url('https://placehold.co/1000x560')">
            ...
            <div class="container position-relative">
                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-xxl-6 col-xl-7 col-lg-8 col-md-10 position-relative dropcap-style-05 last-paragraph-no-margin">
                        <p><span class="alt-font first-letter first-letter-big text-white">N</span><span class="text-white opacity-5">Lorem ipsum is simply dummy text of the printing and typesetting industry. It has survived not only five centuries. Simply dummy text of the printing and typesetting industry. It has survived not only five centuries. Lorem ipsum is simply dummy text of the printing.</span></p>
                    </div>
                </div>
                <!-- end dropcaps item -->
            </div>
