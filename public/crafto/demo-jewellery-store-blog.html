                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-md-8 text-center position-relative page-title-extra-large">
                        <div class="d-flex flex-column extra-very-small-screen">
                            <div class="mt-auto">
                                <h1 class="fw-500 text-dark-gray alt-font mb-0 ls-minus-2px">Latest blog</h1>
                            </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <ul class="blog-modern blog-wrapper grid-loading grid grid-3col xl-grid-3col lg-grid-2col md-grid-2col sm-grid-2col xs-grid-1col gutter-extra-large" data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 500, "delay": 0, "staggervalue": 100, "easing": "easeOutQuad" }'>
                                    ...
                                    <figure class="mb-0 position-relative">
                                        ...
                                        <figcaption class="post-content-wrapper">
                                            <div class="position-relative bg-dark-gray post-content p-25px z-index-2 lh-initial">
                                                ...
                                                <a href="demo-jewellery-store-blog-single-clean.html" class="fs-20 alt-font text-white card-title d-inline-block mb-0">Jewelry has the power to be the one little thing</a>
                                                <div class="box-overlay bg-dark-gray z-index-minus-1"></div>
                                            </div>
                                            <div class="fs-17 alt-font lh-initial bg-base-color text-dark-gray p-15px"><span class="d-inline-block">By <a href="demo-jewellery-store-blog.html" class="text-dark-gray">Elizabeth taylor</a></span><span class="separator d-inline-block fs-14">|</span><a href="#" class="text-dark-gray">22 May 2023</a></div>
                                        </figcaption>
                                    </figure>
                                </div>
                            </li>
                                    ...
                                    <figure class="mb-0 position-relative">
                                        ...
                                        <figcaption class="post-content-wrapper">
                                            <div class="position-relative bg-dark-gray post-content p-25px z-index-2 lh-initial">
                                                ...
                                                <a href="demo-jewellery-store-blog-single-clean.html" class="fs-20 alt-font text-white card-title d-inline-block mb-0"> Jewelry is the most transfor mative thing you can wear </a>
                                                <div class="box-overlay bg-dark-gray z-index-minus-1"></div>
                                            </div>
                                            <div class="fs-17 alt-font lh-initial bg-base-color text-dark-gray p-15px"><span class="d-inline-block">By <a href="demo-jewellery-store-blog.html" class="text-dark-gray">Jonse robbert</a></span><span class="separator d-inline-block fs-14">|</span><a href="#" class="text-dark-gray">08 May 2023</a></div>
                                        </figcaption>
                                    </figure>
                                </div>
                            </li>
                                    ...
                                    <figure class="mb-0 position-relative">
                                        ...
                                        <figcaption class="post-content-wrapper">
                                            <div class="position-relative bg-dark-gray post-content p-25px z-index-2 lh-initial">
                                                ...
                                                <a href="demo-jewellery-store-blog-single-clean.html" class="fs-20 alt-font text-white card-title d-inline-block mb-0">These gems have life in them their colors speak</a>
                                                <div class="box-overlay bg-dark-gray z-index-minus-1"></div>
                                            </div>
                                            <div class="fs-17 alt-font lh-initial bg-base-color text-dark-gray p-15px"><span class="d-inline-block">By <a href="demo-jewellery-store-blog.html" class="text-dark-gray">Den viliamson</a></span><span class="separator d-inline-block fs-14">|</span><a href="#" class="text-dark-gray">28 April 2023</a></div>
                                        </figcaption>
                                    </figure>
                                </div>
                            </li>
                            <!-- end blog item -->
                            <!-- start blog item -->
                            <li class="grid-item lg-mb-50px md-mb-20px">
                                <div class="box-hover text-center">
                                    <figure class="mb-0 position-relative">
                                        <div class="blog-image position-relative overflow-hidden">
                                            <a href="demo-jewellery-store-blog-single-clean.html"><img src="https://placehold.co/800x1015" alt="" /></a>
                                        ...
                                        <figcaption class="post-content-wrapper">
                                            <div class="position-relative bg-dark-gray post-content p-25px z-index-2 lh-initial">
                                                ...
                                                <a href="demo-jewellery-store-blog-single-clean.html" class="fs-20 alt-font text-white card-title d-inline-block mb-0">Jewelry takes people’s minds off your wrinkles </a>
                                                <div class="box-overlay bg-dark-gray z-index-minus-1"></div>
                                            </div>
                                            <div class="fs-17 alt-font lh-initial bg-base-color text-dark-gray p-15px"><span class="d-inline-block">By <a href="demo-jewellery-store-blog.html" class="text-dark-gray">Sarah phillips</a></span><span class="separator d-inline-block fs-14">|</span><a href="#" class="text-dark-gray">19 April 2023</a></div>
                                        </figcaption>
                                    </figure>
                                </div>
                            </li>
                                    ...
                                    <figure class="mb-0 position-relative">
                                        ...
                                        <figcaption class="post-content-wrapper">
                                            <div class="position-relative bg-dark-gray post-content p-25px z-index-2 lh-initial">
                                                ...
                                                <a href="demo-jewellery-store-blog-single-clean.html" class="fs-20 alt-font text-white card-title d-inline-block mb-0">If you don’t know jewelry, know the jeweler</a>
                                                <div class="box-overlay bg-dark-gray z-index-minus-1"></div>
                                            </div>
                                            <div class="fs-17 alt-font lh-initial bg-base-color text-dark-gray p-15px"><span class="d-inline-block">By <a href="demo-jewellery-store-blog.html" class="text-dark-gray">Andy glamere</a></span><span class="separator d-inline-block fs-14">|</span><a href="#" class="text-dark-gray">08 April 2023</a></div>
                                        </figcaption>
                                    </figure>
                                </div>
                            </li>
                                    ...
                                    <figure class="mb-0 position-relative">
                                        ...
                                        <figcaption class="post-content-wrapper">
                                            <div class="position-relative bg-dark-gray post-content p-25px z-index-2 lh-initial">
                                                ...
                                                <a href="demo-jewellery-store-blog-single-clean.html" class="fs-20 alt-font text-white card-title d-inline-block mb-0">A woman needs ropes and ropes of pearls</a>
                                                <div class="box-overlay bg-dark-gray z-index-minus-1"></div>
                                            </div>
                                            <div class="fs-17 alt-font lh-initial bg-base-color text-dark-gray p-15px"><span class="d-inline-block">By <a href="demo-jewellery-store-blog.html" class="text-dark-gray">Jonse robbert</a></span><span class="separator d-inline-block fs-14">|</span><a href="#" class="text-dark-gray">08 March 2023</a></div>
                                        </figcaption>
                                    </figure>
                                </div>
                            </li>
