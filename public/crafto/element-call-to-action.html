...
<html class="no-js" lang="en">
    ...
    <body data-mobile-nav-style="classic">
                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-12 col-xl-6 col-lg-8 text-center position-relative page-title-double-large">
                        <div class="d-flex flex-column justify-content-center extra-very-small-screen">
                            <h1 class="text-dark-gray alt-font ls-minus-1px fw-700 mb-20px">Call to action</h1>
                            <h2 class="text-dark-gray d-inline-block fw-400 ls-0px mb-0">Integrate image, button, and content in a box. Customize the call-to-action with perfect size and color for any design.</h2> 
                        </div>
        ...
        <!-- end page title -->
        <!-- start section -->
        <section class="cover-background one-third-screen sm-h-500px" style="background-image:url('https://placehold.co/1920x760');">
            ...
            <div class="container h-100"> 
                <div class="row align-items-center justify-content-center h-100">
                    <div class="col-xxl-8 col-lg-10 mb-9 md-mb-15 sm-mb-0 position-relative z-index-1 text-center d-flex flex-wrap align-items-center justify-content-center" data-anime='{ "el": "childs", "translateY": [50, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>   
                        ...
                        <h1 class="text-white fw-600 ls-minus-2px mb-45px">We make the creative solutions for <span class="fw-600" data-fancy-text='{ "effect": "rotate", "string": ["business!", "problems!", "brands!"] }'></span></h1> 
        ...
        <section class="big-section position-relative">
            <div id="particles-style-01" class="h-100 position-absolute left-0px top-0 w-100 z-index-minus-1" data-particle="true" data-particle-options='{"particles": {"number": {"value": 25,"density": {"enable": true,"value_area": 2000}},"color": {"value": ["#ffc700", "#232323"]},"shape": {"type": "circle","stroke":{"width":0,"color":"#000000"}},"opacity": {"value": 1,"random": false,"anim": {"enable": false,"speed": 1,"sync": false}},"size": {"value": 8,"random": true,"anim": {"enable": false,"sync": true}},"line_linked":{"enable":false,"distance":0,"color":"#ffffff","opacity":0.4,"width":1},"move": {"enable": true,"speed":1,"direction": "right","random": false,"straight": false}},"interactivity": {"detect_on": "canvas","events": {"onhover": {"enable": false,"mode": "repulse"},"onclick": {"enable": false,"mode": "push"},"resize": true}},"retina_detect": false}'></div> 
            <div class="container position-relative">
                <div class="position-absolute bottom-150px lg-bottom-50px z-index-minus-2 d-none d-lg-block"><img src="https://placehold.co/150x86" data-bottom-top="transform: rotate(10deg) translateX(50px)" data-top-bottom="transform:rotate(-10deg) translateX(-50px)" alt=""/></div>
                <div class="position-absolute top-minus-150px right-50px z-index-minus-2 d-none d-lg-block"><img src="https://placehold.co/650x391" data-bottom-top="transform: rotate(20deg) translateY(50px)" data-top-bottom="transform:rotate(-20deg) translateY(-50px)" alt=""/></div>
                <div class="row justify-content-center">
                    <div class="col-12 col-xl-8 text-center mb-3">
                        <h2 class="text-dark-gray fw-600 ls-minus-2px mb-40px">We would love to hear about start your new project?</h2>
                        <a href="#" class="btn btn-extra-large btn-dark-gray btn-slide-down btn-rounded me-5px ms-5px mb-15px">Start projects<span class="bg-white"></span></a>
                        <a href="#" class="btn btn-extra-large btn-transparent-dark-gray btn-slide-down btn-rounded me-5px ms-5px mb-15px">Get started<span class="bg-dark-gray"></span></a>
                    </div>                    
                </div>
            </div>
        </section>
        ...
        <section class="p-0">
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-12 col-xl-4 col-lg-6 col-md-6 sm-h-450px cover-background" style="background-image: url('https://placehold.co/850x768')"></div>
                    <div class="col-12 col-xl-4 col-lg-6 col-md-6 text-center bg-slate-blue">
                        <div class="p-15 xl-ps-8 xl-pe-8 md-ps-2 md-pe-2">
                            <span class="alt-font d-inline-block mb-15px fs-17 fw-500 text-gradient-light-gray-white text-decoration-line-bottom-medium border-color-base-color-transparent">Explore recent work portfolio</span>
                            <h3 class="text-white alt-font fw-600 mb-20px">Growth for your business strategic</h3>
                            ...
                            <a href="#" class="btn btn-large btn-gradient-sky-blue-pink btn-round-edge btn-hover-animation-switch">
                                <span>
                    ...
                    <div class="col-md-4 d-none d-xl-block cover-background" style="background-image: url('https://placehold.co/850x768')"></div>
                </div>
            </div>
        </section>
        <!-- end section -->
        <!-- start section -->
        <section class="big-section cover-background position-relative background-position-center-bottom" style="background-image: url('images/demo-it-business-about-bg2.jpg')">
            <div class="background-position-center-top background-no-repeat position-absolute h-100 w-100 left-0px top-0px" style="background-image: url('https://placehold.co/1126x630')"></div>
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-12 col-xl-6 col-lg-8 col-md-10 text-center">
                        <div class="alt-font fs-17 fw-700 mb-20px text-base-color d-inline-block text-uppercase text-decoration-line-bottom-medium border-color-base-color">Unlimited design power</div>
                        <div class="cd-headline slide">
                            <div class="fs-120 lg-fs-100 text-dark-gray lh-100 fw-500 mb-10 alt-font ls-minus-5px fancy-text-style-4" data-anime='{ "el": "childs", "opacity": [0, 1], "translateX": [-100, 0], "staggervalue": 300, "duration": 1000, "easing": "easeOutCubic" }'>
                                <span class="d-inline-block" data-bottom-top="transform: translateX(70px)" data-top-bottom="transform: translateX(-70px)">Business</span>
                                <span class="fw-700 d-inline-block" data-fancy-text='{ "effect": "wave", "string": ["strategy", "approach", "planning"], "duration": 4000 }' data-bottom-top="transform: translateX(-70px)" data-top-bottom="transform: translateX(70px)"></span>
                            </div>
                        </div>
                        <a href="#" class="btn btn-extra-large fw-600 btn-rounded with-rounded btn-base-color btn-box-shadow">Purchase Crafto<span class="bg-white text-base-color"><i class="fa-solid fa-arrow-right"></i></span></a>
                    </div>                    
                </div>
            </div>
        </section>
            ...
            <div class="container position-relative">
                <div class="row align-items-center justify-content-center">
                    ...
                    <div class="col-xl-6 text-center text-xl-start lg-mb-30px">
                        ...
                        <span class="fs-19 widget-text opacity-5 fw-300">We will take care of your business accounting services.</span>
                    </div>
                    <!-- end footer column -->
                    <!-- start footer column -->
                    <div class="col-xl-6 text-center text-xl-end">
                        <a href="#" class="btn btn-extra-large btn-white left-icon btn-box-shadow btn-rounded text-transform-none fw-600 primary-font ls-0px d-inline-block align-middle me-15px xs-m-10px"><i class="feather icon-feather-mail"></i>Free consultation</a>
                        <a href="tel:12345678910" class="btn btn-extra-large btn-gradient-pink-orange left-icon btn-box-shadow btn-rounded fw-600 primary-font ls-0px d-inline-block align-middle xs-m-10px"><i class="feather icon-feather-phone-call"></i>+1 234 567 8910</a>
                    </div>
                    <!-- end footer column -->
                </div>
            </div>
        ...
        <!-- end section -->
        <!-- start section -->
        <section class="magic-cursor round-cursor">
            <div class="container">
                <div class="row justify-content-center" data-anime='{ "translateY": [0, 0], "opacity": [0,1], "duration": 1200, "delay": 0, "staggervalue": 150, "easing": "easeOutQuad" }'>
                    <div class="col-12" data-bottom-top="transform:scale(1, 1);" data-top-bottom="transform:scale(1.1, 1.1);">
                        <div class="border-radius-6px h-450px md-h-350px sm-h-400px d-flex flex-wrap align-items-center justify-content-center overflow-hidden cover-background box-shadow-quadruple-large pt-15 md-pt-7 sm-pt-11" style="background-image: url('https://placehold.co/1410x850')">
