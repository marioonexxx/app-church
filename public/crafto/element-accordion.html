                ...
                <div class="row justify-content-center align-items-center">
                    <div class="col-lg-6 col-md-10 position-relative md-mb-50px md-mb-30px"> 
                        <figure class="position-relative mb-0 overflow-hidden" data-anime='{ "effect": "slide", "color": "#f7f7f7", "direction":"rl", "easing": "easeOutQuad", "delay":50}'> 
                            <img src="https://placehold.co/960x1125" class="w-100" alt=""> 
                ...
                <div class="row justify-content-center mt-5">
                    <div class="col-auto icon-with-text-style-08 sm-mb-10px" data-anime='{ "translateX": [-50, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                        <div class="feature-box feature-box-left-icon-middle">
                            ...
                            <div class="feature-box-content">
                                <span class="alt-font text-dark-gray fw-500 fs-18">Looking for help? <a href="#" class="text-decoration-line-bottom text-dark-gray fw-600">Submit a ticket</a></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-auto icon-with-text-style-08" data-anime='{ "translateX": [50, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                        <div class="feature-box feature-box-left-icon-middle">
                            ...
                            <div class="feature-box-content">
                                <span class="alt-font text-dark-gray fw-500 fs-18">Keep in Touch. <a href="#" class="text-decoration-line-bottom text-dark-gray fw-600">Like us on Facebook</a></span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6 align-self-end order-2 order-lg-1" data-anime='{ "el": "childs", "translateY": [100, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                        <div class="outside-box-left-5 outside-box-right-5">
                            <img src="https://placehold.co/775x725" alt="">
                        </div>
                    </div>
                    <div class="col-xxl-5 col-lg-6 pb-7 align-self-end order-xxl-1 order-lg-2" data-anime='{ "el": "childs", "translateY": [50, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                        ...
                        <a href="#" class="btn btn-medium btn-white text-transform-none btn-hover-animation-switch btn-round-edge btn-box-shadow fw-600 mt-15px">
                            <span>
                ...
                <div class="row align-items-center"> 
                    ...
                    <div class="col-xl-6 offset-xl-1 col-lg-6 position-relative" data-anime='{ "el": "childs", "translateX": [50, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 150, "easing": "easeOutQuad" }'> 
                        <div class="outside-box-right-25 md-me-0">
                            <img src="https://placehold.co/995x680" alt="">
                        </div>
                    </div>
                </div>  
            </div>
            ...
            <div class="container">
                <div class="row justify-content-center align-items-center">
                    <div class="col-lg-6 position-relative md-mb-50px sm-mb-15 sm-mt-10" data-anime='{ "translateX": [0, 0], "opacity": [0,1], "duration": 1200, "delay": 0, "staggervalue": 150, "easing": "easeOutQuad" }'>
                        <img src="https://placehold.co/675x560" class="position-relative z-index-9" alt="">
                        <img src="images/demo-corporate-03.png" class="absolute-middle-center xs-w-95" alt="">
                        <img src="https://placehold.co/144x64" class="position-absolute top-50px left-0px xs-left-15px" data-bottom-top="transform: translateY(-50px)" data-top-bottom="transform: translateY(50px)" alt="">
                        <img src="https://placehold.co/67x34" class="position-absolute top-150px left-50px" data-bottom-top="transform: translateY(30px)" data-top-bottom="transform: translateY(-30px)" alt="">
                        <img src="https://placehold.co/61x30" class="position-absolute top-50px right-50px" data-bottom-top="transform: translateY(-50px)" data-top-bottom="transform: translateY(50px)" alt="">
                        <img src="https://placehold.co/93x45" class="position-absolute top-100px right-0px xs-right-15px" data-bottom-top="transform: translateY(30px)" data-top-bottom="transform: translateY(-30px)" alt="">
                    </div>
            ...
            <div class="container">
                <div class="row align-items-center justify-content-center g-0" data-anime='{  "opacity": [0,1], "duration": 600, "delay":0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                    <div class="col-auto d-flex align-items-center">
                        <img src="https://placehold.co/152x68" alt="" class="w-15 me-15px">
                        <div class="fs-17 lh-26 last-paragraph-no-margin text-white pt-15px pb-15px fw-500">
                            <p>Save your precious time and effort spent for finding a solution. <a href="#" class="text-decoration-line-bottom text-white">Contact us now</a></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row align-items-center"> 
                    <div class="col-lg-6 position-relative md-mb-50px text-center text-md-center" data-anime='{ "opacity": [0,1], "duration": 1200, "delay":0, "staggervalue": 150, "easing": "easeOutQuad" }'>
                        <img src="https://placehold.co/560x560" alt="">
                        <img src="https://placehold.co/144x64" class="position-absolute top-70px left-minus-20px lg-left-0px d-none d-sm-block" data-bottom-top="transform: translateY(-50px)" data-top-bottom="transform: translateY(50px)" alt="">
                        <img src="https://placehold.co/240x240" class="position-absolute bottom-0px left-minus-60px lg-left-minus-30px xs-left-minus-10px xs-w-50" data-bottom-top="transform: translateY(50px)" data-top-bottom="transform: translateY(-50px)" alt="">
                        <img src="https://placehold.co/93x45" class="position-absolute top-50 right-90px d-none d-sm-block" data-bottom-top="transform: translateY(-50px)" data-top-bottom="transform: translateY(50px)" alt="">
                    </div>
