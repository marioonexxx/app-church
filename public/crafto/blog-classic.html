                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-12 col-xl-6 col-lg-8 text-center position-relative page-title-double-large">
                        <div class="d-flex flex-column justify-content-center extra-very-small-screen">
                            <h1 class="text-dark-gray alt-font ls-minus-1px fw-700">Blog classic</h1>
                        ...
                        <ul class="blog-classic blog-wrapper grid-loading grid grid-4col xl-grid-4col lg-grid-3col md-grid-2col sm-grid-2col xs-grid-1col gutter-extra-large">
                            ...
                            <li class="grid-item">
                                <div class="card bg-transparent border-0 h-100">
                                    <div class="blog-image position-relative overflow-hidden border-radius-4px">
                                        <a href="demo-elearning-blog-single-simple.html"><img src="https://placehold.co/800x570" alt="" /></a>
                                    </div>
                                    <div class="card-body px-0 pt-30px pb-30px">
                                        ...
                                        <a href="demo-elearning-blog-single-simple.html" class="card-title mb-10px fw-600 fs-17 lh-26 text-dark-gray text-dark-gray-hover d-inline-block w-95">Recognizing the need is the primary condition for design.</a>
                                        <p class="mb-10px w-95">Lorem ipsum is simply dummy printing typesetting industry...</p>
                                        <a href="demo-elearning-blog-single-simple.html" class="card-link alt-font fs-12 text-uppercase text-dark-gray text-dark-gray-hover fw-700">More reading<i class="feather icon-feather-arrow-right icon-very-small"></i></a>
                                    </div>
                                </div>
                            </li>
                            <!-- end blog item -->
                            ...
                            <li class="grid-item">
                                <div class="card bg-transparent border-0 h-100">
                                    ...
                                    <div class="card-body px-0 pt-30px pb-30px">
                                        ...
                                        <a href="demo-elearning-blog-single-simple.html" class="card-title mb-10px fw-600 fs-17 lh-26 text-dark-gray text-dark-gray-hover d-inline-block w-95">At a meta level digital design connects the dots between.</a>
                                        <p class="mb-10px w-95">Lorem ipsum is simply dummy printing typesetting industry...</p>
                                        <a href="demo-elearning-blog-single-simple.html" class="card-link alt-font fs-12 text-uppercase text-dark-gray text-dark-gray-hover fw-700">More reading<i class="feather icon-feather-arrow-right icon-very-small"></i></a>
                                    </div>
                                </div>
                            ...
                            <li class="grid-item">
                                <div class="card bg-transparent border-0 h-100">
                                    ...
                                    <div class="card-body px-0 pt-30px pb-30px">
                                        ...
                                        <a href="demo-elearning-blog-single-simple.html" class="card-title mb-10px fw-600 fs-17 lh-26 text-dark-gray text-dark-gray-hover d-inline-block w-95">Make every business easy with beautiful application store.</a>
                                        <p class="mb-10px w-95">Lorem ipsum is simply dummy printing typesetting industry...</p>
                                        <a href="demo-elearning-blog-single-simple.html" class="card-link alt-font fs-12 text-uppercase text-dark-gray text-dark-gray-hover fw-700">More reading<i class="feather icon-feather-arrow-right icon-very-small"></i></a>
                                    </div>
                                </div>
                            ...
                            <li class="grid-item">
                                <div class="card bg-transparent border-0 h-100">
                                    ...
                                    <div class="card-body px-0 pt-30px pb-30px">
                                        <span class="fs-13 text-uppercase mb-5px d-block"><a href="blog-grid.html" class="text-dark-gray text-dark-gray-hover fw-600 categories-text">Business</a><a href="blog-grid.html" class="blog-date text-dark-gray-hover">20 August 2023</a></span>
                                        <a href="demo-elearning-blog-single-simple.html" class="card-title mb-10px fw-600 fs-17 lh-26 text-dark-gray text-dark-gray-hover d-inline-block w-95">Get in over your head as often and as joyfully as possible.</a>
                                        <p class="mb-10px w-95">Lorem ipsum is simply dummy printing typesetting industry...</p>
                                        <a href="demo-elearning-blog-single-simple.html" class="card-link alt-font fs-12 text-uppercase text-dark-gray text-dark-gray-hover fw-700">More reading<i class="feather icon-feather-arrow-right icon-very-small"></i></a>
                                    </div>
                                </div>
                            ...
                            <li class="grid-item">
                                <div class="card bg-transparent border-0 h-100">
                                    ...
                                    <div class="card-body px-0 pt-30px pb-30px">
                                        <span class="fs-13 text-uppercase mb-5px d-block"><a href="blog-grid.html" class="text-dark-gray text-dark-gray-hover fw-600 categories-text">Creative</a><a href="blog-grid.html" class="blog-date text-dark-gray-hover">18 August 2023</a></span>
                                        <a href="demo-elearning-blog-single-simple.html" class="card-title mb-10px fw-600 fs-17 lh-26 text-dark-gray text-dark-gray-hover d-inline-block w-95">The best way to predict the secure future is to create it.</a>
                                        <p class="mb-10px w-95">Lorem ipsum is simply dummy printing typesetting industry...</p>
                                        <a href="demo-elearning-blog-single-simple.html" class="card-link alt-font fs-12 text-uppercase text-dark-gray text-dark-gray-hover fw-700">More reading<i class="feather icon-feather-arrow-right icon-very-small"></i></a>
                                    </div>
                                </div>
                            ...
                            <li class="grid-item">
                                <div class="card bg-transparent border-0 h-100">
                                    ...
                                    <div class="card-body px-0 pt-30px pb-30px">
                                        <span class="fs-13 text-uppercase mb-5px d-block"><a href="blog-grid.html" class="text-dark-gray text-dark-gray-hover fw-600 categories-text">Business</a><a href="blog-grid.html" class="blog-date text-dark-gray-hover">16 August 2023</a></span>
                                        <a href="demo-elearning-blog-single-simple.html" class="card-title mb-10px fw-600 fs-17 lh-26 text-dark-gray text-dark-gray-hover d-inline-block w-95">Recognizing the need is the primary condition for design.</a>
                                        <p class="mb-10px w-95">Lorem ipsum is simply dummy printing typesetting industry...</p>
                                        <a href="demo-elearning-blog-single-simple.html" class="card-link alt-font fs-12 text-uppercase text-dark-gray text-dark-gray-hover fw-700">More reading<i class="feather icon-feather-arrow-right icon-very-small"></i></a>
                                    </div>
                            ...
                            <li class="grid-item">
                                <div class="card bg-transparent border-0 h-100">
                                    ...
                                    <div class="card-body px-0 pt-30px pb-30px">
                                        <span class="fs-13 text-uppercase mb-5px d-block"><a href="blog-grid.html" class="text-dark-gray text-dark-gray-hover fw-600 categories-text">Marketing</a><a href="blog-grid.html" class="blog-date text-dark-gray-hover">14 August 2023</a></span>
                                        <a href="demo-elearning-blog-single-simple.html" class="card-title mb-10px fw-600 fs-17 lh-26 text-dark-gray text-dark-gray-hover d-inline-block w-95">Fashion and interior design are one and the same.</a>
                                        <p class="mb-10px w-95">Lorem ipsum is simply dummy printing typesetting industry...</p>
                                        <a href="demo-elearning-blog-single-simple.html" class="card-link alt-font fs-12 text-uppercase text-dark-gray text-dark-gray-hover fw-700">More reading<i class="feather icon-feather-arrow-right icon-very-small"></i></a>
                                    </div>
                                </div>
                            ...
                            <li class="grid-item">
                                <div class="card bg-transparent border-0 h-100">
                                    ...
                                    <div class="card-body px-0 pt-30px pb-30px">
                                        <span class="fs-13 text-uppercase mb-5px d-block"><a href="blog-grid.html" class="text-dark-gray text-dark-gray-hover fw-600 categories-text">Business</a><a href="blog-grid.html" class="blog-date text-dark-gray-hover">12 August 2023</a></span>
                                        <a href="demo-elearning-blog-single-simple.html" class="card-title mb-10px fw-600 fs-17 lh-26 text-dark-gray text-dark-gray-hover d-inline-block w-95">Computers are to design as microwaves are to cooking.</a>
                                        <p class="mb-10px w-95">Lorem ipsum is simply dummy printing typesetting industry...</p>
                                        <a href="demo-elearning-blog-single-simple.html" class="card-link alt-font fs-12 text-uppercase text-dark-gray text-dark-gray-hover fw-700">More reading<i class="feather icon-feather-arrow-right icon-very-small"></i></a>
                                    </div>
                                </div>
                            ...
                            <li class="grid-item">
                                <div class="card bg-transparent border-0 h-100">
                                    ...
                                    <div class="card-body px-0 pt-30px pb-30px">
                                        <span class="fs-13 text-uppercase mb-5px d-block"><a href="blog-grid.html" class="text-dark-gray text-dark-gray-hover fw-600 categories-text">Design</a><a href="blog-grid.html" class="blog-date text-dark-gray-hover">10 August 2023</a></span>
                                        <a href="demo-elearning-blog-single-simple.html" class="card-title mb-10px fw-600 fs-17 lh-26 text-dark-gray text-dark-gray-hover d-inline-block w-95">At a meta level digital design connects the dots between.</a>
                                        <p class="mb-10px w-95">Lorem ipsum is simply dummy printing typesetting industry...</p>
                                        <a href="demo-elearning-blog-single-simple.html" class="card-link alt-font fs-12 text-uppercase text-dark-gray text-dark-gray-hover fw-700">More reading<i class="feather icon-feather-arrow-right icon-very-small"></i></a>
                                    </div>
                            ...
                            <li class="grid-item">
                                <div class="card bg-transparent border-0 h-100">
                                    ...
                                    <div class="card-body px-0 pt-30px pb-30px">
                                        <span class="fs-13 text-uppercase mb-5px d-block"><a href="blog-grid.html" class="text-dark-gray text-dark-gray-hover fw-600 categories-text">Business</a><a href="blog-grid.html" class="blog-date text-dark-gray-hover">08 August 2023</a></span>
                                        <a href="demo-elearning-blog-single-simple.html" class="card-title mb-10px fw-600 fs-17 lh-26 text-dark-gray text-dark-gray-hover d-inline-block w-95">Recognizing the need is the primary condition design.</a>
                                        <p class="mb-10px w-95">Lorem ipsum is simply dummy printing typesetting industry...</p>
                                        <a href="demo-elearning-blog-single-simple.html" class="card-link alt-font fs-12 text-uppercase text-dark-gray text-dark-gray-hover fw-700">More reading<i class="feather icon-feather-arrow-right icon-very-small"></i></a>
                                    </div>
                                </div>
                            ...
                            <li class="grid-item">
                                <div class="card bg-transparent border-0 h-100">
                                    ...
                                    <div class="card-body px-0 pt-30px pb-30px">
                                        <span class="fs-13 text-uppercase mb-5px d-block"><a href="blog-grid.html" class="text-dark-gray text-dark-gray-hover fw-600 categories-text">Marketing</a><a href="blog-grid.html" class="blog-date text-dark-gray-hover">06 August 2023</a></span>
                                        <a href="demo-elearning-blog-single-simple.html" class="card-title mb-10px fw-600 fs-17 lh-26 text-dark-gray text-dark-gray-hover d-inline-block w-95">Good design is obvious great design transparent.</a>
                                        <p class="mb-10px w-95">Lorem ipsum is simply dummy printing typesetting industry...</p>
                                        <a href="demo-elearning-blog-single-simple.html" class="card-link alt-font fs-12 text-uppercase text-dark-gray text-dark-gray-hover fw-700">More reading<i class="feather icon-feather-arrow-right icon-very-small"></i></a>
                                    </div>
                                </div>
