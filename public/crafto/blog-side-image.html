                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-12 col-xl-6 col-lg-8 text-center position-relative page-title-double-large">
                        <div class="d-flex flex-column justify-content-center extra-very-small-screen">
                            <h1 class="text-dark-gray alt-font ls-minus-1px fw-700">Blog side image</h1>
                        ...
                        <ul class="blog-side-image blog-wrapper grid-loading grid grid-3col xxl-grid-2col xl-grid-2col lg-grid-2col md-grid-1col sm-grid-1col xs-grid-1col gutter-extra-large">
                            ...
                            <li class="grid-item">
                                <div class="blog-box d-md-flex d-block flex-row h-100 border-radius-6px overflow-hidden box-shadow-extra-large">
                                    <div class="blog-image w-50 sm-w-100 cover-background" style="background-image: url('https://placehold.co/800x923')">
                                        <a href="demo-architecture-blog-single-clean.html" class="blog-post-image-overlay"></a>
                                    </div>
                                    <div class="blog-content w-50 sm-w-100 pt-50px pb-40px ps-40px pe-40px xl-p-30px bg-white d-flex flex-column justify-content-center align-items-start last-paragraph-no-margin">
                                        <a href="blog-masonry.html" class="categories-btn bg-dark-gray text-white text-uppercase fw-500 mb-30px">Creative</a>
                                        <a href="demo-architecture-blog-single-clean.html" class="card-title text-dark-gray text-dark-gray-hover mb-5px fw-600 fs-18 lh-28">Creativity is nothing but a mind set free.</a>
                                        <p>Lorem ipsum is simply text of the printing...</p>
                                        <div class="mt-15px"><span class="separator bg-dark-gray"></span><a href="blog-masonry.html" class="text-dark-gray text-dark-gray-hover d-inline-block fs-15 fw-500 fw-500">Den viliamson</a></div>
                                    </div>
                                </div>
                            </li>
                            <!-- end blog item -->
                            ...
                            <li class="grid-item">
                                <div class="blog-box d-md-flex d-block flex-row h-100 border-radius-6px overflow-hidden box-shadow-extra-large">
                                    ...
                                    <div class="blog-content w-50 sm-w-100 pt-50px pb-40px ps-40px pe-40px xl-p-30px bg-white d-flex flex-column justify-content-center align-items-start last-paragraph-no-margin">
                                        <a href="blog-masonry.html" class="categories-btn bg-dark-gray text-white text-uppercase fw-500 mb-30px">Creative</a>
                                        <a href="demo-architecture-blog-single-clean.html" class="card-title text-dark-gray text-dark-gray-hover mb-5px fw-600 fs-18 lh-28">Simplicity, wit, and good typography.</a>
                                        <p>Lorem ipsum is simply text of the printing...</p>
                                        <div class="mt-15px"><span class="separator bg-dark-gray"></span><a href="blog-masonry.html" class="text-dark-gray text-dark-gray-hover d-inline-block fs-15 fw-500 fw-500">Walton smith</a></div>
                                    </div>
                                </div>
                            </li>
                            <!-- end blog item -->
                            ...
                            <li class="grid-item">
                                <div class="blog-box d-md-flex d-block flex-row h-100 border-radius-6px overflow-hidden box-shadow-extra-large">
                                    ...
                                    <div class="blog-content w-50 sm-w-100 pt-50px pb-40px ps-40px pe-40px xl-p-30px bg-white d-flex flex-column justify-content-center align-items-start last-paragraph-no-margin">
                                        <a href="blog-masonry.html" class="categories-btn bg-dark-gray text-white text-uppercase fw-500 mb-30px">Meetup</a>
                                        <a href="demo-architecture-blog-single-clean.html" class="card-title text-dark-gray text-dark-gray-hover mb-5px fw-600 fs-18 lh-28">What works good is that good different.</a>
                                        <p>Lorem ipsum is simply text of the printing...</p>
                                        <div class="mt-15px"><span class="separator bg-dark-gray"></span><a href="blog-masonry.html" class="text-dark-gray text-dark-gray-hover d-inline-block fs-15 fw-500 fw-500">Rosald smith</a></div>
                                    </div>
                                </div>
                            </li>
                            <!-- end blog item -->
                            ...
                            <li class="grid-item">
                                <div class="blog-box d-md-flex d-block flex-row h-100 border-radius-6px overflow-hidden box-shadow-extra-large">
                                    ...
                                    <div class="blog-content w-50 sm-w-100 pt-50px pb-40px ps-40px pe-40px xl-p-30px bg-white d-flex flex-column justify-content-center align-items-start last-paragraph-no-margin">
                                        <a href="blog-masonry.html" class="categories-btn bg-dark-gray text-white text-uppercase fw-500 mb-30px">Meetup</a>
                                        <a href="demo-architecture-blog-single-clean.html" class="card-title text-dark-gray text-dark-gray-hover mb-5px fw-600 fs-18 lh-28">Look at usual things with unusual.</a>
                                        <p>Lorem ipsum is simply text of the printing...</p>
                                        <div class="mt-15px"><span class="separator bg-dark-gray"></span><a href="blog-masonry.html" class="text-dark-gray text-dark-gray-hover d-inline-block fs-15 fw-500 fw-500">Maya angelou</a></div>
                                    </div>                                        
                                </div>
                            </li>
                            <!-- end blog item -->
                            ...
                            <li class="grid-item">
                                <div class="blog-box d-md-flex d-block flex-row h-100 border-radius-6px overflow-hidden box-shadow-extra-large">
                                    ...
                                    <div class="blog-content w-50 sm-w-100 pt-50px pb-40px ps-40px pe-40px xl-p-30px bg-white d-flex flex-column justify-content-center align-items-start last-paragraph-no-margin">
                                        <a href="blog-masonry.html" class="categories-btn bg-dark-gray text-white text-uppercase fw-500 mb-30px">Creative</a>
                                        <a href="demo-architecture-blog-single-clean.html" class="card-title text-dark-gray text-dark-gray-hover mb-5px fw-600 fs-18 lh-28">Make it simple, but significant.</a>
                                        <p>Lorem ipsum is simply text of the printing...</p>
                                        <div class="mt-15px"><span class="separator bg-dark-gray"></span><a href="blog-masonry.html" class="text-dark-gray text-dark-gray-hover d-inline-block fs-15 fw-500 fw-500">Andy glamer</a></div>
                                    </div>
                                </div>
                            </li>
                            <!-- end blog item -->
                            ...
                            <li class="grid-item">
                                <div class="blog-box d-md-flex d-block flex-row h-100 border-radius-6px overflow-hidden box-shadow-extra-large">
                                    ...
                                    <div class="blog-content w-50 sm-w-100 pt-50px pb-40px ps-40px pe-40px xl-p-30px bg-white d-flex flex-column justify-content-center align-items-start last-paragraph-no-margin">
                                        <a href="blog-masonry.html" class="categories-btn bg-dark-gray text-white text-uppercase fw-500 mb-30px">Business</a>
                                        <a href="demo-architecture-blog-single-clean.html" class="card-title text-dark-gray text-dark-gray-hover mb-5px fw-600 fs-18 lh-28">Do not seek praise seek criticism.</a>
                                        <p>Lorem ipsum is simply text of the printing...</p>
                                        <div class="mt-15px"><span class="separator bg-dark-gray"></span><a href="blog-masonry.html" class="text-dark-gray text-dark-gray-hover d-inline-block fs-15 fw-500 fw-500">Den viliamson</a></div>
                                    </div>
                                </div>
                            ...
                            <li class="grid-item">
                                <div class="blog-box d-md-flex d-block flex-row h-100 border-radius-6px overflow-hidden box-shadow-extra-large">
                                    ...
                                    <div class="blog-content w-50 sm-w-100 pt-50px pb-40px ps-40px pe-40px xl-p-30px bg-white d-flex flex-column justify-content-center align-items-start last-paragraph-no-margin">
                                        <a href="blog-masonry.html" class="categories-btn bg-dark-gray text-white text-uppercase fw-500 mb-30px">Design</a>
                                        <a href="demo-architecture-blog-single-clean.html" class="card-title text-dark-gray text-dark-gray-hover mb-5px fw-600 fs-18 lh-28">Leave it better than you found it.</a>
                                        <p>Lorem ipsum is simply text of the printing...</p>
                                        <div class="mt-15px"><span class="separator bg-dark-gray"></span><a href="blog-masonry.html" class="text-dark-gray text-dark-gray-hover d-inline-block fs-15 fw-500 fw-500">Jones robbert</a></div>
                                    </div>
                                </div>
                            </li>
                            <!-- end blog item -->
                            ...
                            <li class="grid-item">
                                <div class="blog-box d-md-flex d-block flex-row h-100 border-radius-6px overflow-hidden box-shadow-extra-large">
                                    ...
                                    <div class="blog-content w-50 sm-w-100 pt-50px pb-40px ps-40px pe-40px xl-p-30px bg-white d-flex flex-column justify-content-center align-items-start last-paragraph-no-margin">
                                        <a href="blog-masonry.html" class="categories-btn bg-dark-gray text-white text-uppercase fw-500 mb-30px">Design</a>
                                        <a href="demo-architecture-blog-single-clean.html" class="card-title text-dark-gray text-dark-gray-hover mb-5px fw-600 fs-18 lh-28">Fashion fades, only style remains same.</a>
                                        <p>Lorem ipsum is simply text of the printing...</p>
                                        <div class="mt-15px"><span class="separator bg-dark-gray"></span><a href="blog-masonry.html" class="text-dark-gray text-dark-gray-hover d-inline-block fs-15 fw-500 fw-500">Hugh macleod</a></div>
                                    </div>
                                </div>
                            </li>
                            <!-- end blog item -->
                            ...
                            <li class="grid-item">
                                <div class="blog-box d-md-flex d-block flex-row h-100 border-radius-6px overflow-hidden box-shadow-extra-large">
                                    ...
                                    <div class="blog-content w-50 sm-w-100 pt-50px pb-40px ps-40px pe-40px xl-p-30px bg-white d-flex flex-column justify-content-center align-items-start last-paragraph-no-margin">
                                        <a href="blog-masonry.html" class="categories-btn bg-dark-gray text-white text-uppercase fw-500 mb-30px">Business</a>
                                        <a href="demo-architecture-blog-single-clean.html" class="card-title text-dark-gray text-dark-gray-hover mb-5px fw-600 fs-18 lh-28">Everything is design are designed well.</a>
                                        <p>Lorem ipsum is simply text of the printing...</p>
                                        <div class="mt-15px"><span class="separator bg-dark-gray"></span><a href="blog-masonry.html" class="text-dark-gray text-dark-gray-hover d-inline-block fs-15 fw-500 fw-500">Den viliamson</a></div>
                                    </div>
                                </div>
