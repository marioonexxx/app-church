...
<html class="no-js" lang="en">
    ...
    <body data-mobile-nav-style="classic">
                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-12 col-xl-6 col-lg-8 text-center position-relative page-title-double-large">
                        <div class="d-flex flex-column justify-content-center extra-very-small-screen">
                            <h1 class="text-dark-gray alt-font ls-minus-1px fw-700 mb-20px">Highlights</h1>
                            <h2 class="text-dark-gray d-inline-block fw-400 ls-0px mb-0">Easily capture key points in lengthy sentences with our quick and useful Highlight Element. Try it now!</h2> 
                        </div>
            ...
            <div class="container-fluid">
                <div class="row align-items-center justify-content-center">
                    ...
                    <div class="col-xl-5 col-lg-6">
                        <img class="w-100" src="https://placehold.co/1050x645" alt="">
                    </div>
                </div>
            </div>
        </section>
        <!-- end section -->
        <!-- start section -->
        <section class="position-relative" data-parallax-background-ratio="0.3" style="background-image: url('https://placehold.co/1920x1150')">
            <div class="opacity-extra-medium bg-black"></div>
            <div class="container h-100 position-relative">
                <div class="row align-items-center small-screen justify-content-center">
                    <div class="col-xxl-10 col-xl-12 position-relative text-white d-flex flex-column justify-content-center text-center h-100" data-anime='{ "el": "childs", "translateY": [-15, 0], "perspective": [1200,1200], "scale": [1.1, 1], "rotateX": [50, 0], "opacity": [0,1], "duration": 600, "delay": 100, "staggervalue": 300, "easing": "easeOutQuad" }'> 
                        <span class="fs-90 lg-fs-80 md-fs-70 fw-600 text-white ls-minus-2px shadow-none" data-shadow-animation="true" data-animation-delay="500">We develop and create successful <span class="text-highlight">startup<span class="bg-majorelle-blue h-20px bottom-10px separator-animation"></span></span></span>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="big-section">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <span class="text-dark-gray fs-50 lg-fs-40 lh-60 lg-lh-60 shadow-none ls-minus-2px" data-shadow-animation="true" data-animation-delay="500">Tomorrow is the most important <span class="text-highlight">thing in life.<span class="bg-dark-gray h-3px bottom-0px separator-animation"></span></span> Comes into us at midnight very clean. <span class="text-highlight">It's perfect<span class="bg-dark-gray h-3px bottom-0px separator-animation"></span></span> when it arrives and it puts itself in our hands. It hopes we've learned something <span class="text-highlight">from yesterday.<span class="bg-dark-gray h-3px bottom-0px separator-animation"></span></span></span>
                    </div>
                </div>
            </div>
        </section>
        <!-- end section -->
        <!-- start section -->
        <section class="p-0 position-relative" data-parallax-background-ratio="0.3" style="background-image: url('https://placehold.co/1920x1100')">
            <div class="opacity-extra-medium bg-black"></div>
            <div class="container h-100 position-relative">
                <div class="row align-items-center one-fourth-screen justify-content-center">
                    <div class="col-xl-10 position-relative text-white d-flex flex-column justify-content-center text-center h-100" data-anime='{ "el": "childs", "translateY": [-15, 0], "perspective": [1200,1200], "scale": [1.1, 1], "rotateX": [50, 0], "opacity": [0,1], "duration": 600, "delay": 100, "staggervalue": 300, "easing": "easeOutQuad" }'> 
                        <div class="fs-90 lg-fs-80 md-fs-70 fw-600 mb-20px ls-minus-4px overflow-hidden">
                            <div class="d-inline-block" data-anime='{ "translateY": [100, 0], "easing": "easeOutCubic", "duration": 900 }'>
                                We develop and create successful
                                <div class="highlight-separator" data-shadow-animation="true" data-animation-delay="500">
                                    startup<span><img src="images/highlight-separator.svg" alt=""></span>
                                </div>
                            </div>
                        </div>
                    </div>
