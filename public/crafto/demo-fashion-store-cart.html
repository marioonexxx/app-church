                ...
                <div class="row align-items-start">
                    <div class="col-lg-8 pe-50px md-pe-15px md-mb-50px xs-mb-35px">
                                ...
                                <table class="table cart-products">
                                    ...
                                    <tbody>
                                        <tr> 
                                            ...
                                            <td class="product-thumbnail"><a href="demo-jewellery-store-single-product.html"><img class="cart-product-image" src="https://placehold.co/600x765" alt=""></a></td>
                                            <td class="product-name">
                                                <a href="demo-jewellery-store-single-product.html" class="text-dark-gray fw-500 d-block lh-initial">Textured sweater</a> 
                                        ...
                                        <tr> 
                                            ...
                                            <td class="product-thumbnail"><a href="demo-jewellery-store-single-product.html"><img class="cart-product-image" src="https://placehold.co/600x765" alt=""></a></td>
                                            <td class="product-name">
                                                <a href="demo-jewellery-store-single-product.html" class="text-dark-gray fw-500 d-block lh-initial">Bermuda shorts</a> 
                                        ...
                                        <tr> 
                                            ...
                                            <td class="product-thumbnail"><a href="demo-jewellery-store-single-product.html"><img class="cart-product-image" src="https://placehold.co/600x765" alt=""></a></td>
                                            <td class="product-name">
                                                <a href="demo-jewellery-store-single-product.html" class="text-dark-gray fw-500 d-block lh-initial">Pocket sweatshirt</a> 
                        ...
                        <div class="row mt-20px">
                            ...
                            <div class="col-xl-6 col-xxl-5 col-md-6 text-center text-md-end sm-mt-15px">
                                <a href="#" class="btn btn-small border-1 btn-round-edge btn-transparent-light-gray text-transform-none me-15px lg-me-5px">Empty cart</a>
                    ...
                    <div class="col-lg-4">
                        <div class="bg-very-light-gray border-radius-6px p-50px xl-p-30px lg-p-25px">
                                        ...
                                        <th colspan="2" class="fw-500">
                                            ...
                                            <div id="shipping-accordion" class="address-block collapse">
                                                <div class="mt-15px">
                                                    ...
                                                    <a href="#" class="btn btn-small btn-box-shadow btn-round-edge btn-dark-gray w-100">Update</a>
                                                </div>
                                            </div>
                                        </th>
                                    </tr>
                            ...
                            <a href="demo-fashion-store-checkout.html" class="btn btn-dark-gray btn-large btn-switch-text btn-round-edge btn-box-shadow w-100 mt-25px">
                                <span>
