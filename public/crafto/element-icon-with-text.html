...
<html class="no-js" lang="en">
    ...
    <body data-mobile-nav-style="classic">
                    ...
                    <div class="col-auto text-center last-paragraph-no-margin">
                        <div class="feature-box feature-box-left-icon-middle overflow-hidden">
                            ...
                            <div class="feature-box-content last-paragraph-no-margin text-white text-uppercase fs-15 fw-500 ls-05px">
                                Let's make something great work together. <a href="#" class="text-white text-decoration-line-bottom-medium border-1">Got a project in mind?</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-xl-5 offset-xl-1 col-lg-6 md-mb-50px xs-mb-30px" data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                        ...
                        <a href="#" class="btn btn-extra-large btn-gradient-sky-blue-pink btn-hover-animation-switch btn-rounded btn-box-shadow btn-icon-left me-25px text-transform-none">
                            <span> 
                        ...
                        <a href="#" class="btn btn-link btn-hover-animation-switch btn-extra-large text-dark-gray btn-icon-left align-middle fw-600 p-0 xs-mt-20px xs-mb-20px text-transform-none">
                            <span>
        ...
        <!-- end section -->
        <!-- start section -->
        <section class="cover-background" style="background-image: url('https://placehold.co/1920x751')"> 
            <div class="container">  
                <div class="row justify-content-center mb-3">
                    <div class="col-lg-8 text-center" data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 900, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                    ...
                    <div class="col icon-with-text-style-07 transition-inner-all md-mb-30px">
                        <div class="bg-white feature-box h-100 justify-content-start box-shadow-quadruple-large box-shadow-quadruple-large-hover text-start p-17 sm-p-14 border-radius-6px">
                            ...
                            <div class="feature-box-content">
                                ...
                                <a href="#" class="btn btn-link btn-hover-animation-switch btn-extra-large text-base-color fw-600 text-uppercase-inherit">
                                    <span>
                            ...
                            <div class="box-move-bottom-top pt-18 pb-18 ps-15 pe-15 transition-inner-all">
                                ...
                                <div class="feature-box-content last-paragraph-no-margin overflow-hidden">
                                    ...
                                    <div class="move-bottom-top mt-15px">
                                        <a href="#" class="hover-link btn btn-link btn-medium text-white ls-05px">Get started</a>
                                    </div> 
                                </div>
                            </div>
        ...
        <section class="position-relative background-position-center-top overflow-hidden" style="background-image: url('images/vertical-line-bg-medium-gray.svg')">
            <div class="container position-relative">
                <div class="position-absolute top-50px right-minus-50px lg-right-minus-20px d-none d-md-inline-block"><img src="https://placehold.co/140x140" data-bottom-top="transform: rotate(-10deg) translateY(50px)" data-top-bottom="transform:rotate(10deg) translateY(-50px)" alt=""/></div>
                <div class="position-absolute bottom-40px md-bottom-60px left-minus-50px d-none d-md-inline-block"><img src="https://placehold.co/150x86" data-bottom-top="transform: rotate(10deg) translateX(50px)" data-top-bottom="transform:rotate(-10deg) translateX(-50px)" alt=""/></div>
                <div class="row mb-3">
                ...
                <div class="row justify-content-center position-relative" data-anime='{ "el": "childs", "translateY": [50, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                    <div class="col-auto text-center last-paragraph-no-margin">
                        <div class="d-inline-block align-middle me-15px sm-m-5px"><img src="https://placehold.co/46x51" alt=""></div>
                        ...
                        <div class="text-box-wrapper align-items-center d-flex position-relative overflow-hidden border-radius-6px">
                            <div class="text-center w-100">
                                <div class="text-box last-paragraph-no-margin p-15 xxl-p-10 lg-p-5">
                                    <img src="https://placehold.co/61x64" class="mb-30px d-block mx-auto" alt=""/> 
