                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-12 col-xl-6 col-lg-8 text-center position-relative page-title-double-large">
                        <div class="d-flex flex-column justify-content-center extra-very-small-screen">
                            <h1 class="text-dark-gray alt-font ls-minus-1px fw-700 mb-20px">Banners</h1>
                            <h2 class="text-dark-gray d-inline-block fw-400 ls-0px mb-0">Display eye-catching visuals for announcements or important content on your website with our exceptional banner element.</h2> 
                        </div>
        ...
        <section class="bg-extra-dark-slate-blue">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-6 col-md-9 md-mb-30px">
                        <div class="bg-light-red p-60px lg-p-30px md-p-30px border-radius-4px position-relative overflow-hidden">
                            <div class="w-40 md-w-35 sm-w-55 position-relative z-index-1">
                                <span class="text-red fs-15 text-uppercase fw-600 d-block mb-5px">Most popular</span>
                                <h4 class="fw-700 text-dark-gray ls-minus-1px lg-ls-minus-2px mb-20px">Special delicious</h4>
                                <a href="#" class="btn btn-small btn-dark-gray btn-box-shadow btn-round-edge">Order now</a>
                            </div>
                            <img src="https://placehold.co/360x293" class="position-absolute right-0px bottom-0 lg-right-minus-100px xs-right-minus-70px md-w-65 sm-right-minus-50px sm-bottom-minus-0px sm-w-50 xs-w-250px" alt=""/>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-9">
                        <div class="bg-light-red p-60px lg-p-30px md-p-30px border-radius-4px position-relative overflow-hidden">
                            <div class="w-35 sm-w-55 float-end position-relative z-index-1">
                                <span class="text-red fs-15 text-uppercase fw-600 d-block mb-5px">Order $50</span>
                                <h4 class="fw-700 text-dark-gray ls-minus-1px lg-ls-minus-2px mb-20px">Fastest delivery</h4>
                                <a href="#" class="btn btn-small btn-dark-gray btn-box-shadow btn-round-edge">Order now</a>
                            </div>
                            <img src="https://placehold.co/360x293" class="position-absolute left-0px lg-left-minus-50px md-left-minus-30px md-w-65 bottom-0px sm-w-50 xs-w-200px" alt=""/>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col interactive-banner-style-08 md-mb-30px">
                        <figure class="m-0 hover-box overflow-hidden position-relative border-radius-6px">
                            <a class="stretched-link" href="#">
                                <img src="https://placehold.co/1160x605" alt="" />
                            </a>
                            <figcaption class="d-flex flex-column align-items-start justify-content-end position-absolute left-0px top-0px w-100 h-100 p-55px md-p-6">
                                ...
                                <div class="d-flex flex-column w-100 align-items-center">  
                                    <h3 class="alt-font fw-600 text-white mb-10px ls-minus-1px md-fs-40">Classic beard</h3>
                    ...
                    <div class="col interactive-banner-style-08">
                        <figure class="m-0 hover-box overflow-hidden position-relative border-radius-6px">
                            ...
                            <figcaption class="d-flex flex-column align-items-start justify-content-end position-absolute left-0px top-0px w-100 h-100 p-55px md-p-6">
                                ...
                                <div class="d-flex flex-column w-100 align-items-center">  
                                    <h3 class="alt-font fw-600 text-white mb-10px ls-minus-1px md-fs-40">Hair styling</h3>
