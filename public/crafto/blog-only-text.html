                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-12 col-xl-6 col-lg-8 text-center position-relative page-title-double-large">
                        <div class="d-flex flex-column justify-content-center extra-very-small-screen">
                            <h1 class="text-dark-gray alt-font ls-minus-1px fw-700">Blog only text</h1>
                        ...
                        <ul class="blog-only-text blog-wrapper grid-loading grid grid-4col xl-grid-4col lg-grid-3col md-grid-2col sm-grid-2col xs-grid-1col gutter-extra-large">
                            ...
                            <li class="grid-item">
                                <div class="card border-radius-4px box-shadow-extra-large border-0 h-100 overflow-hidden">
                                    <div class="card-body hover-box dark-hover p-15 md-p-12">
                                        <img src="https://placehold.co/1000x1000" class="hover-img" alt="">
                                        <a href="blog-classic.html" class="categories-btn ms-0 bg-dark-gray text-white text-dark-gray-hover text-uppercase alt-font fw-500 mb-70px">Business</a>
                                        <a href="blog-classic.html" class="fs-13 text-uppercase d-block mb-5px text-medium-opacity text-medium-opacity">Jonse robbert</a>
                                        <a href="demo-blogger-blog-single-classic.html" class="card-title d-block fs-20 ls-minus-05px fw-500 text-dark-gray mb-0 w-90">Design can speak the in tongue of art force of commerce.</a> 
                                    </div>
                                </div>
                            </li>
                            <!-- end blog item -->
                            ...
                            <li class="grid-item">
                                <div class="card border-radius-4px box-shadow-extra-large border-0 h-100 overflow-hidden">
                                    <div class="card-body hover-box dark-hover p-15 md-p-12">
                                        <img src="https://placehold.co/1000x1000" class="hover-img" alt="">
                                        <a href="blog-classic.html" class="categories-btn ms-0 bg-dark-gray text-white text-dark-gray-hover text-uppercase alt-font fw-500 mb-70px">Business</a>
                                        <a href="blog-classic.html" class="fs-13 text-uppercase d-block mb-5px text-medium-opacity text-medium-opacity">Den viliamson</a>
                                        <a href="demo-blogger-blog-single-classic.html" class="card-title d-block fs-20 ls-minus-05px fw-500 text-dark-gray mb-0 w-90">Simplicity is process the obvious and adding meaningful.</a>
                                    </div>
                                </div>
                            </li>
                            <!-- end blog item -->
                            ...
                            <li class="grid-item">
                                <div class="card border-radius-4px box-shadow-extra-large border-0 h-100 overflow-hidden">
                                    <div class="card-body hover-box dark-hover p-15 md-p-12">
                                        <img src="https://placehold.co/1000x1000" class="hover-img" alt="">
                                        <a href="blog-classic.html" class="categories-btn ms-0 bg-dark-gray text-white text-dark-gray-hover text-uppercase alt-font fw-500 mb-70px">Marketing</a>
                                        <a href="blog-classic.html" class="fs-13 text-uppercase d-block mb-5px text-medium-opacity text-medium-opacity">Rosald smith</a>
                                        <a href="demo-blogger-blog-single-classic.html" class="card-title d-block fs-20 ls-minus-05px fw-500 text-dark-gray mb-0 w-90">Everything know about midi skirts and how to wear fashion.</a>
                                    </div>
                                </div>
                            </li>
                            <!-- end blog item -->
                            ...
                            <li class="grid-item">
                                <div class="card border-radius-4px box-shadow-extra-large border-0 h-100 overflow-hidden">
                                    <div class="card-body hover-box dark-hover p-15 md-p-12">
                                        <img src="https://placehold.co/1000x1000" class="hover-img" alt="">
                                        <a href="blog-classic.html" class="categories-btn ms-0 bg-dark-gray text-white text-dark-gray-hover text-uppercase alt-font fw-500 mb-70px">Design</a>
                                        <a href="blog-classic.html" class="fs-13 text-uppercase d-block mb-5px text-medium-opacity text-medium-opacity">Andy glamere</a>
                                        <a href="demo-blogger-blog-single-classic.html" class="card-title d-block fs-20 ls-minus-05px fw-500 text-dark-gray mb-0 w-90">Recognizing the need is the primary condition for design.</a>
                                    </div>
                                </div>
                            </li>
                            <!-- end blog item -->
                            ...
                            <li class="grid-item">
                                <div class="card border-radius-4px box-shadow-extra-large border-0 h-100 overflow-hidden">
                                    <div class="card-body hover-box dark-hover p-15 md-p-12">
                                        <img src="https://placehold.co/1000x1000" class="hover-img" alt="">
                                        <a href="blog-classic.html" class="categories-btn ms-0 bg-dark-gray text-white text-dark-gray-hover text-uppercase alt-font fw-500 mb-70px">Business</a>
                                        <a href="blog-classic.html" class="fs-13 text-uppercase d-block mb-5px text-medium-opacity text-medium-opacity">Walton smith</a>
                                        <a href="demo-blogger-blog-single-classic.html" class="card-title d-block fs-20 ls-minus-05px fw-500 text-dark-gray mb-0 w-90">Design can speak the in tongue of art force of commerce.</a>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li class="grid-item">
                                <div class="card border-radius-4px box-shadow-extra-large border-0 h-100 overflow-hidden">
                                    <div class="card-body hover-box dark-hover p-15 md-p-12">
                                        <img src="https://placehold.co/1000x1000" class="hover-img" alt="">
                                        <a href="blog-classic.html" class="categories-btn ms-0 bg-dark-gray text-white text-dark-gray-hover text-uppercase alt-font fw-500 mb-70px">Marketing</a>
                                        <a href="blog-classic.html" class="fs-13 text-uppercase d-block mb-5px text-medium-opacity text-medium-opacity">Hugh macleod</a>
                                        <a href="demo-blogger-blog-single-classic.html" class="card-title d-block fs-20 ls-minus-05px fw-500 text-dark-gray mb-0 w-90">Fashion is something barbarous on for it innovation.</a>
                                    </div>
                                </div>
                            </li>
                            <!-- end blog item -->
                            ...
                            <li class="grid-item">
                                <div class="card border-radius-4px box-shadow-extra-large border-0 h-100 overflow-hidden">
                                    <div class="card-body hover-box dark-hover p-15 md-p-12">
                                        <img src="https://placehold.co/1000x1000" class="hover-img" alt="">
                                        <a href="blog-classic.html" class="categories-btn ms-0 bg-dark-gray text-white text-dark-gray-hover text-uppercase alt-font fw-500 mb-70px">Business</a>
                                        <a href="blog-classic.html" class="fs-13 text-uppercase d-block mb-5px text-medium-opacity text-medium-opacity">Maya angelou</a>
                                        <a href="demo-blogger-blog-single-classic.html" class="card-title d-block fs-20 ls-minus-05px fw-500 text-dark-gray mb-0 w-90">Design can speak the in tongue of art force of commerce.</a>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li class="grid-item">
                                <div class="card border-radius-4px box-shadow-extra-large border-0 h-100 overflow-hidden">
                                    <div class="card-body hover-box dark-hover p-15 md-p-12">
                                        ...
                                        <a href="blog-classic.html" class="categories-btn ms-0 bg-dark-gray text-white text-dark-gray-hover text-uppercase alt-font fw-500 mb-70px">Design</a>
                                        <a href="blog-classic.html" class="fs-13 text-uppercase d-block mb-5px text-medium-opacity text-medium-opacity">Den viliamson</a>
                                        <a href="demo-blogger-blog-single-classic.html" class="card-title d-block fs-20 ls-minus-05px fw-500 text-dark-gray mb-0 w-90">The details are not the details, they make the best design.</a>
                                    </div>
                                </div>
                            </li>
                            <!-- end blog item -->
                            ...
                            <li class="grid-item">
                                <div class="card border-radius-4px box-shadow-extra-large border-0 h-100 overflow-hidden">
                                    <div class="card-body hover-box dark-hover p-15 md-p-12">
                                        ...
                                        <a href="blog-classic.html" class="categories-btn ms-0 bg-dark-gray text-white text-dark-gray-hover text-uppercase alt-font fw-500 mb-70px">Business</a>
                                        <a href="blog-classic.html" class="fs-13 text-uppercase d-block mb-5px text-medium-opacity text-medium-opacity">Jonse robbert</a>
                                        <a href="demo-blogger-blog-single-classic.html" class="card-title d-block fs-20 ls-minus-05px fw-500 text-dark-gray mb-0 w-90">Any product that needs a manual to hard work is broken.</a>
                                    </div>
                                </div>
                            </li>
                            <!-- end blog item -->
                            ...
                            <li class="grid-item">
                                <div class="card border-radius-4px box-shadow-extra-large border-0 h-100 overflow-hidden">
                                    <div class="card-body hover-box dark-hover p-15 md-p-12">
                                        ...
                                        <a href="blog-classic.html" class="categories-btn ms-0 bg-dark-gray text-white text-dark-gray-hover text-uppercase alt-font fw-500 mb-70px">Business</a>
                                        <a href="blog-classic.html" class="fs-13 text-uppercase d-block mb-5px text-medium-opacity text-medium-opacity">Den viliamson</a>
                                        <a href="demo-blogger-blog-single-classic.html" class="card-title d-block fs-20 ls-minus-05px fw-500 text-dark-gray mb-0 w-90">Good design is obvious, great design is more  transparent.</a>
                                    </div>
                                </div>
                            </li>
                            <!-- end blog item -->
                            ...
                            <li class="grid-item">
                                <div class="card border-radius-4px box-shadow-extra-large border-0 h-100 overflow-hidden">
                                    <div class="card-body hover-box dark-hover p-15 md-p-12">
                                        ...
                                        <a href="blog-classic.html" class="categories-btn ms-0 bg-dark-gray text-white text-dark-gray-hover text-uppercase alt-font fw-500 mb-70px">Marketing</a>
                                        <a href="blog-classic.html" class="fs-13 text-uppercase d-block mb-5px text-medium-opacity text-medium-opacity">Rosald smith</a>
                                        <a href="demo-blogger-blog-single-classic.html" class="card-title d-block fs-20 ls-minus-05px fw-500 text-dark-gray mb-0 w-90">Reason and judgment are the qualities of a good leader.</a>
                                    </div>
                                </div>
                            </li>
                            <!-- end blog item -->
                            ...
                            <li class="grid-item">
                                <div class="card border-radius-4px box-shadow-extra-large border-0 h-100 overflow-hidden">
                                    <div class="card-body hover-box dark-hover p-15 md-p-12">
                                        ...
                                        <a href="blog-classic.html" class="categories-btn ms-0 bg-dark-gray text-white text-dark-gray-hover text-uppercase alt-font fw-500 mb-70px">Business</a>
                                        <a href="blog-classic.html" class="fs-13 text-uppercase d-block mb-5px text-medium-opacity text-medium-opacity">Rosald smith</a>
                                        <a href="demo-blogger-blog-single-classic.html" class="card-title d-block fs-20 ls-minus-05px fw-500 text-dark-gray mb-0 w-90">Everything i know about midi skirts and how to wearing.</a>
                                    </div>
                                </div>
                            </li>
                            <!-- end blog item -->
