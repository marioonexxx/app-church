...
<html class="no-js" lang="en">
    ...
    <body data-mobile-nav-style="classic">
                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-12 col-xl-6 col-lg-8 text-center position-relative page-title-double-large">
                        <div class="d-flex flex-column justify-content-center extra-very-small-screen">
                            <h1 class="text-dark-gray alt-font ls-minus-1px fw-700 mb-20px">Blockquote</h1>
                            <h2 class="text-dark-gray d-inline-block fw-400 ls-0px mb-0">A blockquote in HTML designates quoted text, visually set apart for content citations with identation.</h2> 
                        </div>
        ...
        <!-- end page title -->
        <!-- start section -->
        <section class="bg-spring-wood pb-0">
            <div class="container"> 
                    ...
                    <div class="col-lg-6 md-mb-50px sm-mb-30px">
                        <div class="blockquote-style-01">
                            ...
                            <blockquote class="mb-0 d-table last-paragraph-no-margin">
                                <p class="fs-32 text-dark-gray ls-minus-1px w-90 lg-w-100 mb-15px">The food you eat can be either the safest and most powerful medicine or the <span class="fw-600 text-decoration-line-bottom">slowest form of poison.</span></p>
                                <div class="fw-500 text-dark-gray mt-15px">- Alexander harvard</div>
                            </blockquote>
                            <!-- end blockquote -->
                        </div>
                    </div>
        ...
        <!-- end section -->
        <!-- start section -->
        <section class="cover-background" style="background-image: url('images/demo-decor-store-footer-bg.jpg')">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-12 col-xl-7 position-relative blockquote-style-02 text-center">
                        <!-- start blockquote -->
                        <i class="ti-quote-left text-tussock-yellow icon-extra-large mb-15px d-inline-block"></i>
                        <h3 class="text-white mb-20px fw-500 w-90 mx-auto">What's my style is not your style and I don't see how you can define it. It's something that expresses who you are in your own way.</h3>
                        <div class="text-uppercase alt-font text-tussock-yellow fw-600 fs-14 ls-1px">- Desmond anthony -</div>
                        <!-- end blockquote -->
                    </div>
                </div> 
            </div>
        ...
        <!-- end section --> 
        <!-- start section -->
        <section class="background-repeat big-section" style="background-image:url('images/demo-spa-salon-home-bg-01.jpg');">
            <div class="container"> 
                <div class="row justify-content-center align-items-center blockquote-style-03">
                    <div class="col-xl-3 col-lg-4 col-md-5 text-center sm-mb-20px">
        ...
        <section class="big-section">
            <div class="container"> 
                <div class="row justify-content-center">
                    <div class="col-lg-11" data-bottom-top="transform:translateX(50px)" data-top-bottom="transform:translateX(-50px)">                    
                        <div class="row g-0 blockquote-style-04 mt-6">
                            <div class="col-md-4 blockquote-img position-relative z-index-1">
                                <img src="https://placehold.co/363x460" class="d-none d-md-block" alt="">
                            </div>
                            <div class="col-md-8">
                                <div class="blockquote-content bg-crusoe-green position-relative overflow-hidden h-100 d-flex align-items-center">
                                    <img src="images/blockquote-right-icon.svg" class="position-absolute right-0px bottom-0px h-350px md-h-180px lg-h-250px xl-h-300px" alt="">
                                    <blockquote class="position-relative z-index-1 mb-0 last-paragraph-no-margin">
                                        <p class="fs-24 md-fs-20 text-white ls-minus-05px w-75 sm-w-80">Once you understand the foundations of cooking whatever kind you link. whather it's <span class="text-decoration-underline fw-600">french or italian or japanese you really don't need a cookbook anymore.</span></p>
                                        <div class="fs-20 md-fs-18 fw-600 text-white mt-25px">Tomas burgess <span class="d-block fs-17 opacity-6 fw-400">Executive chef</span></div>
                                    </blockquote>
                                </div>
                            </div>
                        </div>
