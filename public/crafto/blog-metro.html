                        ...
                        <ul class="blog-metro blog-wrapper grid-loading grid grid-4col xl-grid-4col lg-grid-3col md-grid-2col sm-grid-2col xs-grid-1col gutter-large">
                                ...
                                <figure class="position-relative mb-0 overflow-hidden">
                                    ...
                                    <figcaption class="d-flex flex-column justify-content-end h-100 ps-7 pe-7 pt-6 pb-6">
                                        <div class="blog-categories mb-auto">
                                            <a href="blog-masonry.html" class="categories-btn bg-white text-dark-gray text-uppercase alt-font fw-700 ms-0 mb-auto align-self-start">Design</a>
                                        </div>
                                        <a href="blog-masonry.html" class="fs-13 alt-font mb-5px text-white opacity-6 text-uppercase">30 August 2023</a>
                                        <a href="demo-web-agency-blog-single-creative.html" class="text-white card-title fs-20 lh-30 fw-500 alt-font">It takes a real designer to design for women.</a>
                                    </figcaption>
                                </figure>
                            </li>                            
                            <!-- end blog item -->
                            ...
                            <li class="grid-item">
                                <figure class="position-relative mb-0 overflow-hidden">
                                    ...
                                    <figcaption class="d-flex flex-column justify-content-end h-100 ps-14 pe-14 pt-12 pb-12 sm-ps-7 sm-pe-7 sm-pt-6 sm-pb-6">
                                        <div class="blog-categories mb-auto">
                                            <a href="blog-masonry.html" class="categories-btn bg-white text-dark-gray text-uppercase alt-font fw-700 ms-0 mb-auto align-self-start">Adventure</a>
                                        </div>
                                        <a href="blog-masonry.html" class="fs-13 alt-font mb-5px text-white opacity-6 text-uppercase">28 August 2023</a>
                                        <a href="demo-web-agency-blog-single-creative.html" class="text-white card-title fs-20 lh-30 fw-500 w-85 sm-w-100 alt-font">Experience breathtaking views and perspectives.</a>
                                    </figcaption>
                                </figure>
                            </li>
                            <!-- end blog item -->
                            ...
                            <li class="grid-item">
                                <figure class="position-relative mb-0 overflow-hidden">
                                    ...
                                    <figcaption class="d-flex flex-column justify-content-end h-100 ps-14 pe-14 pt-12 pb-12 sm-ps-7 sm-pe-7 sm-pt-6 sm-pb-6">
                                        <div class="blog-categories mb-auto">
                                            <a href="blog-masonry.html" class="categories-btn bg-white text-dark-gray text-uppercase alt-font fw-700 ms-0 mb-auto align-self-start">Luxurious</a>
                                        </div>
                                        <a href="blog-masonry.html" class="fs-13 alt-font mb-5px text-white opacity-6 text-uppercase">26 August 2023</a>
                                        <a href="demo-web-agency-blog-single-creative.html" class="text-white card-title fs-20 lh-30 fw-500 w-85 sm-w-100 alt-font">Get in over your head as often and as joyfully.</a>
                                    </figcaption>
                                </figure>
                            </li>
                            <!-- end blog item -->
                            ...
                            <li class="grid-item grid-item-double">
                                <figure class="position-relative mb-0 overflow-hidden">
                                    ...
                                    <figcaption class="d-flex flex-column justify-content-end h-100 ps-7 pe-7 pt-6 pb-6">
                                        ...
                                        <a href="blog-masonry.html" class="fs-13 alt-font mb-5px text-white opacity-6 text-uppercase">24 August 2023</a>
                                        <a href="demo-web-agency-blog-single-creative.html" class="text-white card-title fs-20 lh-30 fw-500 alt-font">Build up healthy habits and strong peaceful life.</a>
                                    </figcaption>
                                </figure>
                            </li>
                            <!-- end blog item -->
                            ...
                            <li class="grid-item">
                                <figure class="position-relative mb-0 overflow-hidden">
                                    ...
                                    <figcaption class="d-flex flex-column justify-content-end h-100 ps-14 pe-14 pt-12 pb-12 sm-ps-7 sm-pe-7 sm-pt-6 sm-pb-6">
                                        ...
                                        <a href="blog-masonry.html" class="fs-13 alt-font mb-5px text-white opacity-6 text-uppercase">22 August 2023</a>
                                        <a href="demo-web-agency-blog-single-creative.html" class="text-white card-title fs-20 lh-30 fw-500 w-85 sm-w-100 alt-font">Some people just try to celebrate the joys of life.</a>
                                    </figcaption>
                                </figure>
                            </li>                            
                            <!-- end blog item -->
                            ...
                            <li class="grid-item">
                                <figure class="position-relative mb-0 overflow-hidden">
                                    ...
                                    <figcaption class="d-flex flex-column justify-content-end h-100 ps-14 pe-14 pt-12 pb-12 sm-ps-7 sm-pe-7 sm-pt-6 sm-pb-6">
                                        ...
                                        <a href="blog-masonry.html" class="fs-13 alt-font mb-5px text-white opacity-6 text-uppercase">20 August 2023</a>
                                        <a href="demo-web-agency-blog-single-creative.html" class="text-white card-title fs-20 lh-30 fw-500 w-85 sm-w-100 alt-font">Teamwork is essential for small teams challenges.</a>
                                    </figcaption>
                                </figure>
                            </li>
                            <!-- end blog item -->
                            ...
                            <li class="grid-item">
                                <figure class="position-relative mb-0 overflow-hidden">
                                    ...
                                    <figcaption class="d-flex flex-column justify-content-end h-100 ps-14 pe-14 pt-12 pb-12 sm-ps-7 sm-pe-7 sm-pt-6 sm-pb-6">
                                        ...
                                        <a href="blog-masonry.html" class="fs-13 alt-font mb-5px text-white opacity-6 text-uppercase">18 August 2023</a>
                                        <a href="demo-web-agency-blog-single-creative.html" class="text-white card-title fs-20 lh-30 fw-500 w-85 sm-w-100 alt-font">It takes a real designer to design for real women.</a>
                                    </figcaption>
                                </figure>
                            </li>                            
                            <!-- end blog item -->
                            ...
                            <li class="grid-item">
                                <figure class="position-relative mb-0 overflow-hidden">
                                    ...
                                    <figcaption class="d-flex flex-column justify-content-end h-100 ps-14 pe-14 pt-12 pb-12 sm-ps-7 sm-pe-7 sm-pt-6 sm-pb-6">
                                        ...
                                        <a href="blog-masonry.html" class="fs-13 alt-font mb-5px text-white opacity-6 text-uppercase">16 August 2023</a>
                                        <a href="demo-web-agency-blog-single-creative.html" class="text-white card-title fs-20 lh-30 fw-500 w-85 sm-w-100 alt-font">Many focus on embracing what they can control.</a>
                                    </figcaption>
                                </figure>
                            </li>
                            <!-- end blog item -->
                            ...
                            <li class="grid-item">
                                <figure class="position-relative mb-0 overflow-hidden">
                                    ...
                                    <figcaption class="d-flex flex-column justify-content-end h-100 ps-14 pe-14 pt-12 pb-12 sm-ps-7 sm-pe-7 sm-pt-6 sm-pb-6">
                                        ...
                                        <a href="blog-masonry.html" class="fs-13 alt-font mb-5px text-white opacity-6 text-uppercase">14 August 2023</a>
                                        <a href="demo-web-agency-blog-single-creative.html" class="text-white card-title fs-20 lh-30 fw-500 w-85 sm-w-100 alt-font">A business needs a successful mix of design.</a>
                                    </figcaption>
                                </figure>
                            </li>
                            <!-- end blog item -->
                            ...
                            <li class="grid-item">
                                <figure class="position-relative mb-0 overflow-hidden">
                                    ...
                                    <figcaption class="d-flex flex-column justify-content-end h-100 ps-14 pe-14 pt-12 pb-12 sm-ps-7 sm-pe-7 sm-pt-6 sm-pb-6">
                                        ...
                                        <a href="blog-masonry.html" class="fs-13 alt-font mb-5px text-white opacity-6 text-uppercase">12 August 2023</a>
                                        <a href="demo-web-agency-blog-single-creative.html" class="text-white card-title fs-20 lh-30 fw-500 w-85 sm-w-100 alt-font">A dream doesn't become reality through magic.</a>
                                    </figcaption>
                                </figure>
                            </li>
                            <!-- end blog item -->
