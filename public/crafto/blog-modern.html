                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-12 col-xl-6 col-lg-8 text-center position-relative page-title-double-large">
                        <div class="d-flex flex-column justify-content-center extra-very-small-screen">
                            <h1 class="text-dark-gray alt-font ls-minus-1px fw-700">Blog modern</h1>
                                ...
                                <div class="box-hover text-center">
                                    <figure class="mb-0 position-relative">
                                        <div class="blog-image position-relative overflow-hidden">
                                            <a href="demo-blogger-blog-single-classic.html"><img src="https://placehold.co/800x1015" alt="" /></a>
                                        </div>
                                        <figcaption class="post-content-wrapper">
                                            <div class="position-relative bg-dark-gray post-content p-30px z-index-2">
                                                <div class="hover-text">
                                                    <a href="blog-simple.html" class="text-gradient-light-purple-light-orange fs-15 text-uppercase fw-600 mb-5px d-inline-block">Agency</a>
                                                </div>
                                                <a href="demo-blogger-blog-single-classic.html" class="card-title mb-0 fs-19 lh-26 text-white d-inline-block">It takes a real designer to design for real women</a>
                                                <div class="box-overlay bg-dark-gray z-index-minus-1"></div>
                                            </div>
                                            <div class="fs-14 bg-white p-15px lh-initial"><span class="d-inline-block">By <a href="blog-simple.html" class="text-dark-gray-hover">Jonse robbert</a></span><span class="separator d-inline-block">|</span><a href="blog-simple.html" class="text-dark-gray-hover">30 June 2023</a></div>
                                        </figcaption>
                                    </figure>
                                </div>
                            </li>
                                ...
                                <div class="box-hover text-center">
                                    <figure class="mb-0 position-relative">
                                        ...
                                        <figcaption class="post-content-wrapper">
                                            <div class="position-relative bg-dark-gray post-content p-30px z-index-2">
                                                <div class="hover-text">
                                                    <a href="blog-simple.html" class="text-gradient-light-purple-light-orange fs-15 text-uppercase fw-600 mb-5px d-inline-block">Branding</a>
                                                </div>
                                                <a href="demo-blogger-blog-single-classic.html" class="card-title mb-0 fs-19 lh-26 text-white d-inline-block">Experience breathtaking views and perspectives</a>
                                                <div class="box-overlay bg-dark-gray z-index-minus-1"></div>
                                            </div>
                                            <div class="fs-14 bg-white p-15px lh-initial"><span class="d-inline-block">By <a href="blog-simple.html" class="text-dark-gray-hover">Rosald smith</a></span><span class="separator d-inline-block">|</span><a href="blog-simple.html" class="text-dark-gray-hover">28 June 2023</a></div>
                                        </figcaption>
                                    </figure>
                                </div>
                            </li>
                                ...
                                <div class="box-hover text-center">
                                    <figure class="mb-0 position-relative">
                                        ...
                                        <figcaption class="post-content-wrapper">
                                            <div class="position-relative bg-dark-gray post-content p-30px z-index-2">
                                                <div class="hover-text">
                                                    <a href="blog-simple.html" class="text-gradient-light-purple-light-orange fs-15 text-uppercase fw-600 mb-5px d-inline-block">Business</a>
                                                </div>
                                                <a href="demo-blogger-blog-single-classic.html" class="card-title mb-0 fs-19 lh-26 text-white d-inline-block">Teamwork is essential for small teams to challenges</a>
                                                <div class="box-overlay bg-dark-gray z-index-minus-1"></div>
                                            </div>
                                            <div class="fs-14 bg-white p-15px lh-initial"><span class="d-inline-block">By <a href="blog-simple.html" class="text-dark-gray-hover">Den viliamson</a></span><span class="separator d-inline-block">|</span><a href="blog-simple.html" class="text-dark-gray-hover">26 June 2023</a></div>
                                        </figcaption>
                                    </figure>
                                </div>
                            </li>
                                ...
                                <div class="box-hover text-center">
                                    <figure class="mb-0 position-relative">
                                        ...
                                        <figcaption class="post-content-wrapper">
                                            <div class="position-relative bg-dark-gray post-content p-30px z-index-2">
                                                <div class="hover-text">
                                                    <a href="blog-simple.html" class="text-gradient-light-purple-light-orange fs-15 text-uppercase fw-600 mb-5px d-inline-block">Luxurious</a>
                                                </div>
                                                <a href="demo-blogger-blog-single-classic.html" class="card-title mb-0 fs-19 lh-26 text-white d-inline-block">Everything is designed things designed looks</a>
                                                <div class="box-overlay bg-dark-gray z-index-minus-1"></div>
                                            </div>
                                            <div class="fs-14 bg-white p-15px lh-initial"><span class="d-inline-block">By <a href="blog-simple.html" class="text-dark-gray-hover">Andy glamere</a></span><span class="separator d-inline-block">|</span><a href="blog-simple.html" class="text-dark-gray-hover">24 June 2023</a></div>
                                        </figcaption>
                                    </figure>
                                </div>
                            </li>
                                    ...
                                    <figure class="mb-0 position-relative">
                                        ...
                                        <figcaption class="post-content-wrapper">
                                            <div class="position-relative bg-dark-gray post-content p-30px z-index-2">
                                                ...
                                                <a href="demo-blogger-blog-single-classic.html" class="card-title mb-0 fs-19 lh-26 text-white d-inline-block">Build up healthy habits and strong peaceful life</a>
                                                <div class="box-overlay bg-dark-gray z-index-minus-1"></div>
                                            </div>
                                            <div class="fs-14 bg-white p-15px lh-initial"><span class="d-inline-block">By <a href="blog-simple.html" class="text-dark-gray-hover">Jonse robbert</a></span><span class="separator d-inline-block">|</span><a href="blog-simple.html" class="text-dark-gray-hover">22 June 2023</a></div>
                                        </figcaption>
                                    </figure>
                                </div>
                            </li>
                                    ...
                                    <figure class="mb-0 position-relative">
                                        ...
                                        <figcaption class="post-content-wrapper">
                                            <div class="position-relative bg-dark-gray post-content p-30px z-index-2">
                                                ...
                                                <a href="demo-blogger-blog-single-classic.html" class="card-title mb-0 fs-19 lh-26 text-white d-inline-block">Some people just try to celebrate the joys of life</a>
                                                <div class="box-overlay bg-dark-gray z-index-minus-1"></div>
                                            </div>
                                            <div class="fs-14 bg-white p-15px lh-initial"><span class="d-inline-block">By <a href="blog-simple.html" class="text-dark-gray-hover">Rosald smith</a></span><span class="separator d-inline-block">|</span><a href="blog-simple.html" class="text-dark-gray-hover">20 June 2023</a></div>
                                        </figcaption>
                                    </figure>
                                </div>
                            </li>
                                    ...
                                    <figure class="mb-0 position-relative">
                                        ...
                                        <figcaption class="post-content-wrapper">
                                            <div class="position-relative bg-dark-gray post-content p-30px z-index-2">
                                                ...
                                                <a href="demo-blogger-blog-single-classic.html" class="card-title mb-0 fs-19 lh-26 text-white d-inline-block">Many focus on embracing what they can control</a>
                                                <div class="box-overlay bg-dark-gray z-index-minus-1"></div>
                                            </div>
                                            <div class="fs-14 bg-white p-15px lh-initial"><span class="d-inline-block">By <a href="blog-simple.html" class="text-dark-gray-hover">Den viliamson</a></span><span class="separator d-inline-block">|</span><a href="blog-simple.html" class="text-dark-gray-hover">18 June 2023</a></div>
                                        </figcaption>
                                    </figure>
                                </div>
                            </li>
                                    ...
                                    <figure class="mb-0 position-relative">
                                        ...
                                        <figcaption class="post-content-wrapper">
                                            <div class="position-relative bg-dark-gray post-content p-30px z-index-2">
                                                ...
                                                <a href="demo-blogger-blog-single-classic.html" class="card-title mb-0 fs-19 lh-26 text-white d-inline-block">No matter what you're feeling or experiencing</a>
                                                <div class="box-overlay bg-dark-gray z-index-minus-1"></div>
                                            </div>
                                            <div class="fs-14 bg-white p-15px lh-initial"><span class="d-inline-block">By <a href="blog-simple.html" class="text-dark-gray-hover">Andy glamere</a></span><span class="separator d-inline-block">|</span><a href="blog-simple.html" class="text-dark-gray-hover">16 June 2023</a></div>
                                        </figcaption>
                                    </figure>
                                </div>
                            </li>
                                ...
                                <div class="box-hover text-center">
                                    <figure class="mb-0 position-relative">
                                        ...
                                        <figcaption class="post-content-wrapper">
                                            ...
                                            <div class="fs-14 bg-white p-15px lh-initial"><span class="d-inline-block">By <a href="blog-simple.html" class="text-dark-gray-hover">Jonse robbert</a></span><span class="separator d-inline-block">|</span><a href="blog-simple.html" class="text-dark-gray-hover">14 June 2023</a></div>
                                        </figcaption>
                                    </figure>
                                </div>
                            </li>
                                ...
                                <div class="box-hover text-center">
                                    <figure class="mb-0 position-relative">
                                        ...
                                        <figcaption class="post-content-wrapper">
                                            ...
                                            <div class="fs-14 bg-white p-15px lh-initial"><span class="d-inline-block">By <a href="blog-simple.html" class="text-dark-gray-hover">Rosald smith</a></span><span class="separator d-inline-block">|</span><a href="blog-simple.html" class="text-dark-gray-hover">12 June 2023</a></div>
                                        </figcaption>
                                    </figure>
                                </div>
                            </li>
                                    ...
                                    <figure class="mb-0 position-relative">
                                        ...
                                        <figcaption class="post-content-wrapper">
                                            <div class="position-relative bg-dark-gray post-content p-30px z-index-2">
                                                ...
                                                <a href="demo-blogger-blog-single-classic.html" class="card-title mb-0 fs-19 lh-26 text-white d-inline-block">The pessimist sees difficulty in opportunity</a>
                                                <div class="box-overlay bg-dark-gray z-index-minus-1"></div>
                                            </div>
                                            <div class="fs-14 bg-white p-15px lh-initial"><span class="d-inline-block">By <a href="blog-simple.html" class="text-dark-gray-hover">Den viliamson</a></span><span class="separator d-inline-block">|</span><a href="blog-simple.html" class="text-dark-gray-hover">10 June 2023</a></div>
                                        </figcaption>
                                    </figure>
                                </div>
                            </li>
                                    ...
                                    <figure class="mb-0 position-relative">
                                        ...
                                        <figcaption class="post-content-wrapper">
                                            <div class="position-relative bg-dark-gray post-content p-30px z-index-2">
                                                ...
                                                <a href="demo-blogger-blog-single-classic.html" class="card-title mb-0 fs-19 lh-26 text-white d-inline-block">Sometimes we're tested not to show weaknesses</a>
                                                <div class="box-overlay bg-dark-gray z-index-minus-1"></div>
                                            </div>
                                            <div class="fs-14 bg-white p-15px lh-initial"><span class="d-inline-block">By <a href="blog-simple.html" class="text-dark-gray-hover">Andy glamere</a></span><span class="separator d-inline-block">|</span><a href="blog-simple.html" class="text-dark-gray-hover">08 June 2023</a></div>
                                        </figcaption>
                                    </figure>
                                </div>
                            </li>
