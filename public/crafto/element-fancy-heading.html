...
<html class="no-js" lang="en">
    ...
    <body data-mobile-nav-style="classic">
        ...
        <header>
            <!-- start navigation -->
            <nav class="navbar navbar-expand-lg header-light bg-transparent disable-fixed header-demo" data-header-hover="light">
        ...
        <!-- end header -->
        <!-- start section -->
        <section class="full-screen sm-h-450px bg-very-light-gray background-position-center-top overflow-hidden ipad-top-space-margin" style="background-image: url(images/vertical-line-bg-small-medium-gray.svg)">
            <div id="particles-style-02" class="position-absolute h-100 top-0 left-0 w-100 z-index-1 sm-h-450px" data-particle="true" data-particle-options='{"particles":{"number":{"value":200,"density":{"enable":true,"value_area":800}},"color":{"value":"#f7f7f7"},"shape":{"type":"circle","stroke":{"width":0,"color":"#000000"},"polygon":{"nb_sides":5},"image":{"src":"img/github.svg","width":100,"height":100}},"opacity":{"value":1,"random":false,"anim":{"enable":false,"speed":1,"opacity_min":0.1,"sync":false}},"size":{"value":12,"random":true,"anim":{"enable":false,"speed":40,"size_min":0.1,"sync":false}},"line_linked":{"enable":false,"distance":150,"color":"#ffffff","opacity":0.4,"width":1},"move":{"enable":true,"speed":6,"direction":"none","random":false,"straight":false,"out_mode":"out","bounce":false,"attract":{"enable":false,"rotateX":600,"rotateY":1200}}},"interactivity":{"detect_on":"canvas","events":{"onhover":{"enable":true,"mode":"repulse"},"onclick":{"enable":true,"mode":"push"},"resize":true},"modes":{"grab":{"distance":400,"line_linked":{"opacity":1}},"bubble":{"distance":400,"size":40,"duration":2,"opacity":8,"speed":3},"repulse":{"distance":200,"duration":0.4},"push":{"particles_nb":4},"remove":{"particles_nb":2}}},"retina_detect":true}'></div>
            ...
            <div class="position-absolute left-0px top-0px h-100 w-130px d-none d-xl-inline-block z-index-2" data-anime='{ "translateX": [-30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                <div class="vertical-title-center align-items-center justify-content-center">
                    <div class="title fs-18 text-dark-gray fw-600">Unique heading animation</div>
                </div>
            </div>
        </section>
        <!-- end section -->
        ...
        <section class="full-screen sm-h-auto position-relative">
            <div class="bg-extra-dark-slate-blue h-100 lg-w-100 position-absolute top-0 left-0" data-bottom-top="width:20%" data-center-top="width:100%;"></div>
            <div class="container position-relative h-100">
                <div class="row justify-content-center align-items-center h-100">
                    <div class="col-md-12" data-anime='{ "scale":[1.1,1], "opacity": [0,1], "duration": 500, "delay": 0, "staggervalue": 200, "easing": "easeOutQuad" }'>
                        <h2 class="fs-90 lg-fs-70 fw-600 text-white image-mask cover-background pb-10px mb-0" style="background-image: url('https://placehold.co/1920x1100')">Great design made simple easy affordable for you. The perfect option for creatives businesses makers agencies.</h2>
                    </div>
                </div>
            </div>
            <div class="position-absolute left-0px top-0px h-100 w-130px d-none d-xl-inline-block" data-anime='{ "translateX": [-30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                <div class="vertical-title-center align-items-center justify-content-center">
                    <div class="title fs-18 text-white fw-500">Image masking</div>
                </div>
            </div>
        </section>
        <!-- end section -->
        ...
        <!-- end section -->
        <!-- start section -->
        <section class="bg-light-majorelle-blue position-relative">
            <div class="container h-100">
                <div class="row justify-content-center align-items-center one-half-screen sm-h-350px">
                    <div class="col-12">
            ...
            <div class="position-absolute left-0px top-0px h-100 w-130px d-none d-xl-inline-block" data-anime='{ "translateX": [-30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                <div class="vertical-title-center align-items-center justify-content-center">
                    <div class="title fs-18 text-dark-gray fw-600">Animate every character</div>
                </div>
            </div>
        </section>
        <!-- end section -->
        <!-- start section -->
        <section class="position-relative" data-parallax-background-ratio="0.8" style="background-image: url('https://placehold.co/1920x1100')">
            <div class="opacity-extra-medium bg-black"></div>
            <div class="container h-100 position-relative">
                <div class="row align-items-center justify-content-center one-half-screen sm-h-350px">
                    <div class="col-12">
                        <h2 class="fs-200 lg-fs-170 md-fs-130 xs-fs-90 fw-600 ls-minus-5px text-white mb-0">
                            <span data-anime='{ "el": "words", "rotateX": [50, 0], "perspective": [1000,1200], "scale": [1.1, 1], "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>Animate every word.</span>
                        </h2>
                    </div>
                </div>
            </div>
            <div class="position-absolute left-0px top-0px h-100 w-130px d-none d-xl-inline-block" data-anime='{ "translateX": [-30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                <div class="vertical-title-center align-items-center justify-content-center">
                    <div class="title fs-18 text-white fw-500">Animate every word</div>
                </div>
            </div>
        </section>
        <!-- end section -->
        ...
        <section class="position-relative">
            <div class="container h-100">
                <div class="row align-items-center one-half-screen sm-h-auto">
                    <div class="col-xxl-10 col-xl-11">
                        <span class="fs-80 lg-fs-75 sm-fs-60 ls-minus-2px fw-600 text-dark-gray" data-anime='{ "el": "lines", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>We strive to develop real world web solutions that are ideal for small to large projects with bespoke project requirements.</span>
                    </div>
                </div>
            </div>
            <div class="position-absolute left-0px top-0px h-100 w-130px d-none d-xl-inline-block" data-anime='{ "translateX": [-30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                <div class="vertical-title-center align-items-center justify-content-center">
                    <div class="title fs-18 text-dark-gray fw-600">Animate every line</div>
                </div>
            </div>
        </section>
        <!-- end section -->
        <div class="page-content position-relative">
            <!-- start section -->
            <section class="position-relative pb-0 overflow-hidden" data-background="#d8e6df">
                    ...
                    <div class="row align-items-center justify-content-center one-half-screen sm-h-350px">
                        <div class="col-12">
                            <span class="fancy-text-style-4"> 
                                <span class="fs-130 xl-fs-110 lg-fs-90 md-fs-80 xs-fs-60 fs-500 mb-0 text-dark-gray fw-300 ls-minus-4px d-block">Great design made <span class="fw-600" data-fancy-text='{ "effect": "wave", "direction": "up", "speed": 50, "string": ["affordable", "simple", "creative"], "duration": 2500 }'></span> for you.</span>
                            </span>
                        </div>
                    </div>
                </div>
                <div class="position-absolute left-0px top-0px h-100 w-130px d-none d-xl-inline-block" data-anime='{ "translateX": [-30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                    <div class="vertical-title-center align-items-center justify-content-center">
                        <div class="title fs-18 text-dark-gray fw-600">Rotating words - Up wave effect</div>
                    </div>
                </div>
            </section>
            <!-- end section -->
            <!-- start section -->
            <section class="position-relative pt-0 overflow-hidden" data-background="#232323">
                <div class="container h-100" data-bottom-top="transform: translateY(50px)" data-top-bottom="transform: translateY(-50px)">
                    <div class="row align-items-center justify-content-center one-half-screen sm-h-350px">
                        <div class="col-12">
                            <span class="fancy-text-style-4"> 
                                <span class="fs-130 xl-fs-110 lg-fs-90 md-fs-80 xs-fs-60 fs-500 mb-0 text-white fw-300 ls-minus-2px d-block">Great design made <span class="fw-600" data-fancy-text='{ "effect": "fade", "speed": 70, "string": ["affordable", "simple", "creative"], "duration": 2500 }'></span> for you.</span>
                            </span>
                        </div>
                    </div>
                </div>
                <div class="position-absolute left-0px top-0px h-100 w-130px d-none d-xl-inline-block" data-anime='{ "translateX": [-30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                    <div class="vertical-title-center align-items-center justify-content-center">
                        <div class="title fs-18 text-white fw-500">Rotating words - Fade effect</div>
                    </div>
                </div>
            </section>
            <!-- end section -->
            <!-- start section -->
            <section class="position-relative pt-0 overflow-hidden" data-background="#ebe3d6">
                <div class="container h-100" data-bottom-top="transform: translateY(50px)" data-top-bottom="transform: translateY(-50px)">
                    <div class="row align-items-center justify-content-center one-half-screen sm-h-350px">
                        <div class="col-12">
                            <span class="fancy-text-style-4"> 
                                <span class="fs-130 xl-fs-110 lg-fs-90 md-fs-80 xs-fs-60 fs-500 mb-0 text-dark-gray fw-300 ls-minus-4px d-block">Great design made <span class="fw-600" data-fancy-text='{ "effect": "rotate", "speed": 50, "string": ["affordable", "simple", "creative"], "duration": 2500 }'></span> for you.</span>
                            </span>
                        </div>
                    </div>
                </div>
                <div class="position-absolute left-0px top-0px h-100 w-130px d-none d-xl-inline-block" data-anime='{ "translateX": [-30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                    <div class="vertical-title-center align-items-center justify-content-center">
                        <div class="title fs-18 text-dark-gray fw-600">Rotating words - Rotate effect</div>
                    </div>
                </div>
            </section>
            <!-- end section -->
            ...
            <section class="position-relative pt-0 overflow-hidden" data-background="#232323">
                <div class="container h-100" data-bottom-top="transform: translateY(50px)" data-top-bottom="transform: translateY(-50px)">
                    <div class="row align-items-center justify-content-center one-half-screen sm-h-350px">
                        <div class="col-12">
                            <span class="fancy-text-style-4"> 
                                <span class="fs-130 xl-fs-110 lg-fs-90 md-fs-80 xs-fs-60 fs-500 mb-0 text-white fw-300 ls-minus-2px d-block">Great design made <span class="fw-600" data-fancy-text='{ "effect": "slide", "direction": "right", "color": "#ffe400", "speed": 100, "string": ["affordable", "simple", "creative"], "duration": 2500 }'></span> for you.</span>
                            </span>
                        </div>
                    </div>
                </div>
                <div class="position-absolute left-0px top-0px h-100 w-130px d-none d-xl-inline-block" data-anime='{ "translateX": [-30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                    <div class="vertical-title-center align-items-center justify-content-center">
                        <div class="title fs-18 text-white fw-500">Rotating words - Slide effect</div>
                    </div>
                </div>
            </section>
            <!-- end section -->
            <!-- start section -->
            <section class="position-relative pt-0 overflow-hidden" data-background="#e1e6ea">
                <div class="container h-100" data-bottom-top="transform: translateY(50px)" data-top-bottom="transform: translateY(-50px)">
                    <div class="row align-items-center justify-content-center one-half-screen sm-h-350px">
                        <div class="col-12">
                            <span class="fancy-text-style-4"> 
                                <span class="fs-130 xl-fs-110 lg-fs-90 md-fs-80 xs-fs-60 fs-500 mb-0 text-dark-gray fw-300 ls-minus-2px d-block">Great design made <span class="fw-600" data-fancy-text='{ "effect": "jump", "speed": 20, "string": ["affordable", "simple", "creative"], "duration": 2500 }'></span> for you.</span>
                            </span>
                        </div>
                    </div>
                </div>
                <div class="position-absolute left-0px top-0px h-100 w-130px d-none d-xl-inline-block" data-anime='{ "translateX": [-30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                    <div class="vertical-title-center align-items-center justify-content-center">
                        <div class="title fs-18 text-dark-gray fw-600">Rotating words - Jump effect</div>
                    </div>
                </div>
            </section>
            <!-- end section -->
            ...
            <section class="position-relative pt-0 overflow-hidden" data-background="#232323">
                <div class="container h-100" data-bottom-top="transform: translateY(50px)" data-top-bottom="transform: translateY(-50px)">
                    <div class="row align-items-center justify-content-center one-half-screen sm-h-350px">
                        <div class="col-12">
                            <span class="fancy-text-style-4"> 
                                <span class="fs-130 xl-fs-110 lg-fs-90 md-fs-80 xs-fs-60 fs-500 mb-0 text-white fw-300 ls-minus-2px d-block">Great design made <span class="fw-600" data-fancy-text='{ "effect": "zoom", "speed": 70, "string": ["affordable", "simple", "creative"], "duration": 2500 }'></span> for you.</span>
                            </span>
                        </div>
                    </div>
                </div>
                <div class="position-absolute left-0px top-0px h-100 w-130px d-none d-xl-inline-block" data-anime='{ "translateX": [-30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                    <div class="vertical-title-center align-items-center justify-content-center">
                        <div class="title fs-18 text-white fw-500">Rotating words - Zoom effect</div>
                    </div>
                </div>
            </section>
            <!-- end section -->
            ...
            <section class="position-relative pt-0 overflow-hidden" data-background="#e1e6ea">
                <div class="container h-100" data-bottom-top="transform: translateY(50px)" data-top-bottom="transform: translateY(-50px)">
                    <div class="row align-items-center justify-content-center one-half-screen sm-h-350px">
                        <div class="col-12">
                            <span class="fancy-text-style-4"> 
                                <span class="fs-130 xl-fs-110 lg-fs-90 md-fs-80 xs-fs-60 fs-500 mb-0 text-dark-gray fw-300 ls-minus-2px d-block">Great design made <span class="fw-600" data-fancy-text='{ "effect": "rubber-band", "direction": "left", "speed": 100, "string": ["affordable", "simple", "creative"], "duration": 3000 }'></span> for you.</span>
                            </span>
                        </div>
                    </div>
                </div>
                <div class="position-absolute left-0px top-0px h-100 w-130px d-none d-xl-inline-block" data-anime='{ "translateX": [-30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                    <div class="vertical-title-center align-items-center justify-content-center">
                        <div class="title fs-18 text-dark-gray fw-600">Rotating words - Rubber band effect</div>
                    </div>
                </div>
            </section>
            <!-- end section -->
            ...
            <section class="position-relative pt-0 overflow-hidden" data-background="#232323">
                <div class="container h-100" data-bottom-top="transform: translateY(50px)" data-top-bottom="transform: translateY(-50px)">
                    <div class="row align-items-center justify-content-center one-half-screen sm-h-350px">
                        <div class="col-12">
                            <span class="fancy-text-style-4"> 
                                <span class="fs-130 xl-fs-110 lg-fs-90 md-fs-80 xs-fs-60 fs-500 mb-0 text-white fw-300 ls-minus-2px d-block">Great design made <span class="fw-600" data-fancy-text='{ "effect": "curve", "string": ["affordable", "simple", "creative"], "duration": 2500 }'></span> for you.</span>
                            </span>
                        </div>
                    </div>
                </div>
                <div class="position-absolute left-0px top-0px h-100 w-130px d-none d-xl-inline-block" data-anime='{ "translateX": [-30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                    <div class="vertical-title-center align-items-center justify-content-center">
                        <div class="title fs-18 text-white fw-500">Rotating words - Curve effect</div>
                    </div>
                </div>
            </section>
            <!-- end section -->
            <!-- start section -->
            <section class="position-relative pt-0 overflow-hidden" data-background="#ece3eb">
                <div class="container h-100" data-bottom-top="transform: translateY(50px)" data-top-bottom="transform: translateY(-50px)">
                    <div class="row align-items-center justify-content-center one-half-screen sm-h-350px">
                        <div class="col-12">
                            <span class="fancy-text-style-4"> 
                                <span class="fs-130 xl-fs-110 lg-fs-90 md-fs-80 xs-fs-60 fs-500 mb-0 text-dark-gray fw-300 ls-minus-2px d-block">Great design made <span class="fw-600" data-fancy-text='{ "effect": "smooth-wave", "direction": "down", "speed": 40, "string": ["affordable", "simple", "creative"], "duration": 3000 }'></span> for you.</span>
                            </span>
                        </div>
                    </div>
                </div>
                <div class="position-absolute left-0px top-0px h-100 w-130px d-none d-xl-inline-block" data-anime='{ "translateX": [-30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                    <div class="vertical-title-center align-items-center justify-content-center">
                        <div class="title fs-18 text-dark-gray fw-600">Rotating words - Smooth wave style</div>
                    </div>
                </div>
            </section>
            <!-- end section -->
        ...
        <section class="position-relative">
            <div class="container h-100">
                <div class="row align-items-center justify-content-center small-screen">
                    <div class="col-12 text-center">
                        <h2 class="fs-160 lg-fs-130 fw-600 text-outline text-outline-color-dark-gray text-outline-width-3px ls-minus-3px mb-0" style="font-family: arial">Text <span class="text-outline-width-5px">outline</span></h2>
                    </div>
                </div>
            </div>
            <div class="position-absolute left-0px top-0px h-100 w-130px d-none d-xl-inline-block" data-anime='{ "translateX": [-30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                <div class="vertical-title-center align-items-center justify-content-center">
                    <div class="title fs-18 text-dark-gray fw-600">Text outline</div>
                </div>
            </div>
        </section>
        <!-- end section -->
