...
<html class="no-js" lang="en">
    ...
    <body data-mobile-nav-style="classic">
                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-12 col-xl-6 col-lg-8 text-center position-relative page-title-double-large">
                        <div class="d-flex flex-column justify-content-center extra-very-small-screen">
                            <h1 class="text-dark-gray alt-font ls-minus-1px fw-700 mb-20px">Clients</h1>
                            <h2 class="text-dark-gray d-inline-block fw-400 ls-0px mb-0">Client element showcases collaborations elegantly, display names and brands with sleek design and customization options.</h2> 
                        </div>
        ...
        <!-- end page title -->
        <!-- start section -->
        <section class="big-section bg-gradient-very-light-gray pb-2">
            <div class="container">
                <div class="row align-items-center mb-5 xs-mb-7">
                    <div class="col-md-8 text-center text-md-start sm-mb-20px">
                        <h3 class="text-dark-gray fw-500 mb-0 ls-minus-2px shadow-none" data-shadow-animation="true" data-animation-delay="700">Some of <span class="fw-700 text-highlight d-inline-block">clients<span class="bg-base-color h-10px bottom-5px opacity-9 separator-animation"></span></span></h3>
                    </div>
                    <div class="col-md-4">
                        <div class="d-flex justify-content-center justify-content-md-end">
                            <a href="#" class="fw-600 text-dark-gray text-dark-gray-hover d-flex align-items-center">View all clients<span class="d-flex align-items-center justify-content-center bg-dark-gray h-40px w-40px text-center rounded-circle fs-16 text-white ms-10px"><i class="feather icon-feather-arrow-right"></i></span></a>
                        </div>
                    </div>
                </div>
                <div class="row row-cols-1 position-relative">
                    <div class="col swiper slider-four-slide clients-style-01 magic-cursor light pb-10 sm-pb-15" data-slider-options='{ "slidesPerView": 1, "spaceBetween": 30, "loop": true, "pagination": { "el": ".slider-four-slide-pagination-1", "clickable": true }, "autoplay": { "delay": 3000, "disableOnInteraction": false }, "navigation": { "nextEl": ".slider-four-slide-next-1", "prevEl": ".slider-four-slide-prev-1" }, "keyboard": { "enabled": true, "onlyInViewport": true }, "breakpoints": { "1200": { "slidesPerView": 4 }, "992": { "slidesPerView": 3 }, "768": { "slidesPerView": 2 } }, "effect": "slide" }'>
                        ...
                        <div class="swiper-pagination slider-four-slide-pagination-1 swiper-pagination-style-1 swiper-pagination-clickable swiper-pagination-bullets sm-w-100"></div>
                        <!-- end slider pagination --> 
                    </div>
                    <!-- start slider navigation -->

                    <!-- <div class="slider-four-slide-prev-2 fw-900 text-dark-gray swiper-button-prev slider-navigation-style-03"><i class="icon feather icon-feather-arrow-left icon-small"></i></div>
                    <div class="slider-four-slide-next-2 fw-900 text-dark-gray swiper-button-next slider-navigation-style-03"><i class="icon feather icon-feather-arrow-right icon-small"></i></div>-->
        ...
        <!-- end section -->
        <!-- start section -->
        <section class="bg-dark-slate-blue big-section overflow-hidden" data-parallax-background-ratio="0.5" style="background-image: url(https://placehold.co/1920x1100)">
            <div class="opacity-medium bg-black"></div>
            <div class="container">
                <div class="row position-relative clients-style-02">
                    <div class="col swiper slider-four-slide text-center" data-slider-options='{ "slidesPerView": 1, "spaceBetween": 30, "loop": true, "pagination": { "el": ".slider-four-slide-pagination-2", "clickable": true }, "autoplay": { "delay": 4000, "disableOnInteraction": false }, "navigation": { "nextEl": ".slider-four-slide-next-02", "prevEl": ".slider-four-slide-prev-02" }, "keyboard": { "enabled": true, "onlyInViewport": true }, "breakpoints": { "1200": { "slidesPerView": 4 }, "992": { "slidesPerView": 3 }, "768": { "slidesPerView": 2 } }, "effect": "slide" }'>
                        <div class="swiper-wrapper">
                            <!-- start client item -->
                            <div class="swiper-slide">
                                <a href="#"><img src="https://placehold.co/301x202" class="border-radius-5px" alt="" /></a>
                            </div>
                            <!-- end client item -->
                            <!-- start client item -->
                            <div class="swiper-slide">
                                <a href="#"><img src="https://placehold.co/300x200" class="border-radius-5px" alt="" /></a>
                            </div>
                            <!-- end client item -->
                            <!-- start client item -->
                            <div class="swiper-slide">
                    ...
                    <!-- <div class="slider-four-slide-prev-02 fw-900 text-dark-gray bg-base-color swiper-button-prev slider-navigation-style-03"><i class="icon feather icon-feather-arrow-left icon-small"></i></div>
                    <div class="slider-four-slide-next-02 fw-900 text-dark-gray swiper-button-next slider-navigation-style-03"><i class="icon feather icon-feather-arrow-right icon-small"></i></div> -->
                </div>
            </div>
        </section>
        <!-- end section -->
        <!-- start section --> 
        <section class="bg-gradient-solitude-blue-transparent big-section">
            <div class="container overlap-gap-section"> 
                <div class="row justify-content-center mb-4">
                    <div class="col-xxl-8 col-lg-8 col-md-10 text-center" data-anime='{ "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 150, "easing": "easeOutQuad" }'>
                        <h2 class="fw-600 text-dark-gray ls-minus-1px">Trusted by over 26,300 reputed companies</h2>
                    </div>
                </div>
                ...
                <div class="row justify-content-center mt-6 sm-mt-40px">
                    <div class="col-12 d-block d-sm-flex align-items-center text-center text-sm-start justify-content-center fs-22">
                        <div class="me-5px xs-ms-10px d-inline-block align-middle"><i class="fa-regular fa-heart text-red"></i></div> 
                        <div class="d-inline-block align-middle">Join the <span class="fw-700 text-dark-gray text-decoration-line-bottom-medium">10000+</span> companies trusting our agency.</div>
                    </div>
                </div>
            </div>
        </section>
        <!-- end section -->
        <!-- start section -->
        <section class="bg-dark-gray background-position-center-top position-relative overflow-hidden" style="background-image: url('images/demo-vertical-portfolio-dotted-pattern.svg')">
            <div class="position-absolute top-50px right-minus-50px z-index-9 d-none d-xxl-block" data-anime='{ "opacity": [0,1], "duration": 600, "delay":1000, "staggervalue": 300, "easing": "easeOutQuad" }'>
            ...
            <div class="container"> 
                <div class="row justify-content-center align-items-center mb-5 sm-mb-30px" data-anime='{ "el": "childs", "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue":200, "easing": "easeOutQuad" }'>
                    <div class="col-auto pe-25px border-2 border-end border-color-yellow sm-border-end-0 sm-pe-15px">
                        <span class="fs-16 text-uppercase text-white ls-1px">Associates brand</span>
                    </div>
                    <div class="col-12 col-md-auto ps-25px sm-ps-15px text-center">
                        <h3 class="alt-font fw-600 text-white ls-minus-1px mb-0">Brands available</h3>
                    </div>
                </div>
                <div class="row row-cols-1 row-cols-lg-4 row-cols-md-4 row-cols-sm-2 clients-style-04 mt-6 sm-mt-50px border border-color-transparent-white-light position-relative z-index-9" data-anime='{ "translateY": [0, 0], "opacity": [0,1], "duration": 600, "delay":0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                    <!-- start client item -->
                ...
                <div class="row mt-7 sm-mt-9" data-anime='{ "translateY": [30, 0], "opacity": [0,1], "duration": 800, "delay": 300, "staggervalue": 250, "easing": "easeOutQuad" }'>
                    <div class="col-12 text-center">
                        <div class="d-inline-block bg-yellow fw-600 text-dark-gray text-uppercase border-radius-30px ps-20px pe-20px fs-12 me-10px sm-m-5px">Trust</div>
                        <div class="d-inline-block align-middle"><span class="fs-24 alt-font text-white d-block mb-0">Join the 10000+ companies trusting crafto.</span></div>
                    </div>
                </div>
            </div>
        </section>
        <!-- end section -->
        <!-- start section -->
        <section class="big-section cover-background background-position-center-top" style="background-image: url(images/demo-conference-page-bg.jpg)">
            <div class="container">
                <div class="row row-cols-1 row-cols-lg-5 row-cols-md-3 row-cols-sm-3 text-center justify-content-center clients-style-05 pt-4 pb-4" data-anime='{ "el": "childs", "translateY": [20,0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                    <!-- start client item -->
        ...
        <!-- end section -->
        <!-- start section -->
        <section class="ps-13 pe-13 lg-ps-2 lg-pe-2 background-no-repeat background-position-center-top" style="background-image: url('https://placehold.co/1126x630')">
            <div class="container-fluid">
                <div class="row justify-content-center align-items-center mb-3">
                    <div class="col-md-12 text-center">
                        <h3 class="text-dark-gray fw-500 mb-0 ls-minus-2px shadow-none" data-shadow-animation="true" data-animation-delay="700">Valuable <span class="fw-700 text-highlight d-inline-block">customers<span class="bg-red h-10px bottom-5px opacity-9 separator-animation"></span></span></h3>
                    </div>
                </div>
                <div class="row row-cols-1 row-cols-md-4 row-cols-sm-2 clients-style-06" data-anime='{ "el": "childs", "scale": [0,1], "opacity": [0,1], "duration": 300, "delay": 0, "staggervalue": 200, "easing": "easeOutQuad" }'>
                    ...
                    <!-- start client item -->
                    <div class="col client-box text-center pt-5 pb-5 sm-pt-8 sm-pb-8">
                        <a href="#"><img src="images/logo-monday.svg" class="h-40px md-h-30px sm-h-40px" alt="" /></a>
                    </div>
                    <!-- end client item -->
                    <!-- start client item -->
                    <div class="col client-box text-center pt-5 pb-5 sm-pt-8 sm-pb-8">
                        <a href="#"><img src="images/logo-google.svg" class="h-40px md-h-30px sm-h-40px" alt="" /></a>
                    </div>
                    <!-- end client item -->
                    <!-- start client item -->
                    <div class="col client-box text-center pt-5 pb-5 sm-pt-8 sm-pb-8">
        ...
        <!-- end section -->
        <!-- start section -->
        <section class="big-section" data-parallax-background-ratio="0.5" style="background-image: url(https://placehold.co/1920x1100)">
            <div class="opacity-extra-medium bg-dark-slate-blue"></div>
            <div class="container">
                <div class="row row-cols-1 row-cols-lg-3 row-cols-md-2 justify-content-center">
                    <!-- start client item -->
                    <div class="col clients-style-07 md-mb-30px">
                        <div class="d-flex align-items-center justify-content-center overflow-hidden position-relative client-box bg-white min-h-250px">
                            <img src="https://placehold.co/225x110" alt="" />
                            <div class="client-info dark-hover">
                                <div class="d-flex align-items-center justify-content-center client-content bg-base-color w-40px h-40px">
                                    <div class="client-icon">
                                        <i class="feather icon-feather-plus icon-small text-white"></i>
                                    </div>
                                    <div class="d-flex flex-column align-items-center justify-content-center client-link p-40px text-center last-paragraph-no-margin">
                                        <span class="fs-20 text-white fw-500 mb-5px">Snapdeal</span>
                                        <p class="text-white opacity-5">Lorem ipsum is simply dummy text printing typesetting industry.</p>
                                    </div>
                    ...
                    <!-- start client item -->
                    <div class="col clients-style-07 md-mb-30px">
                        <div class="d-flex align-items-center justify-content-center overflow-hidden position-relative client-box box-shadow-extra-large bg-white min-h-250px">
                            <img src="https://placehold.co/225x110" alt="" />
                            <div class="client-info dark-hover">
                                <div class="d-flex align-items-center justify-content-center client-content bg-base-color w-40px h-40px">
                                    <div class="client-icon">
                                    ...
                                    <div class="d-flex flex-column align-items-center justify-content-center client-link p-40px text-center last-paragraph-no-margin">
                                        <span class="fs-20 text-white fw-500 mb-5px">Flipkart</span>
                                        <p class="text-white opacity-5">Lorem ipsum is simply dummy text printing typesetting industry.</p>
                                    </div>
                                    <div class="box-overlay bg-base-color"></div>
                                </div>
                    ...
                    <!-- end client item -->
                    <!-- start client item -->
                    <div class="col clients-style-07">
                        <div class="d-flex align-items-center justify-content-center overflow-hidden position-relative client-box box-shadow-extra-large bg-white min-h-250px">
                            <img src="https://placehold.co/225x110" alt="" />
                            <div class="client-info dark-hover">
                                <div class="d-flex align-items-center justify-content-center client-content bg-base-color w-40px h-40px">
                                    ...
                                    <div class="d-flex flex-column align-items-center justify-content-center client-link p-40px text-center last-paragraph-no-margin">
                                        <span class="fs-20 text-white fw-500 mb-5px">Jobong</span>
                                        <p class="text-white opacity-5">Lorem ipsum is simply dummy text printing typesetting industry.</p>
                                    </div>
                                    <div class="box-overlay bg-base-color"></div>
                                </div>
