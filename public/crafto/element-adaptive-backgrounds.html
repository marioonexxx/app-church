                            ...
                            <div class="row row-cols-1 row-cols-lg-3 row-cols-md-2 justify-content-center" data-anime='{ "el": "childs", "translateY": [-15, 0], "perspective": [1200,1200], "scale": [1.1, 1], "rotateX": [50, 0], "opacity": [0,1], "duration": 800, "delay": 200, "staggervalue": 300, "easing": "easeOutQuad" }'>
                                <div class="col icon-with-text-style-07 md-mb-30px">
                                    <div class="hover-box light-hover feature-box bg-dark-gray h-100 overflow-hidden p-13 xxl-p-10 xl-p-8 text-start">
                                        <a href="#" class="ms-0 text-white text-uppercase fw-600 mb-30 fs-16 d-inline-block">Web design</a> 
                                ...
                                <div class="col icon-with-text-style-07 md-mb-30px">
                                    <div class="hover-box light-hover feature-box bg-dark-gray h-100 overflow-hidden p-13 xxl-p-10 xl-p-8 text-start">
                                        <a href="#" class="ms-0 text-white text-uppercase fw-600 mb-30 fs-16 d-inline-block">Web development</a> 
                                ...
                                <div class="col icon-with-text-style-07">
                                    <div class="hover-box light-hover feature-box bg-dark-gray h-100 overflow-hidden p-13 xxl-p-10 xl-p-8 text-start">
                                        <a href="#" class="ms-0 text-white text-uppercase fw-600 mb-30 fs-16 d-inline-block">eCommerce solutions</a> 
                                ...
                                <div class="col-md-auto menu-item ps-40px pe-40px lg-ps-30px lg-pe-30px position-relative">
                                    ...
                                    <div class="hover-reveal d-none d-xl-block">
                                        <div class="hover-reveal__inner">
                                            <div class="hover-reveal__img" style="background-image: url(https://placehold.co/430x430);">
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="container">
                <div class="row mb-8">
                    <div class="col-12">
                        ...
                        <a href="mailto:info@domain.com" class="text-dark-gray text-dark-gray-hover fs-100 md-fs-70 xs-fs-50 fw-400 lh-120 md-lh-95 xs-lh-60 float-end ls-minus-3px" data-anime='{"translateX": [50, 0], "opacity": [0,1], "duration": 800, "delay": 200, "staggervalue": 300, "easing": "easeOutQuad" }'>info@domain.com</a>
                    </div>
                </div>
                <div class="row">
