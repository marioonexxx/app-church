...
<html class="no-js" lang="en">
    ...
    <body data-mobile-nav-style="classic"> 
        ...
        <!-- end header -->
        <!-- start section -->
        <section class="one-fourth-screen sm-mb-50px"  data-parallax-background-ratio="0.5" style="background-image: url(https://placehold.co/1920x1100)"></section>
        <!-- end section -->
        <!-- start section -->
        <section class="p-0">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-10 overlap-section text-center">
                        <div class="p-10 box-shadow-extra-large border-radius-4px bg-white text-center">
                            <a href="blog-grid.html" class="btn btn-large fw-400 ps-20px pe-20px pt-5px pb-5px btn-gradient-sky-blue-pink btn-round-edge mb-3 sm-mb-15px">Fashion</a>
                            ...
                            <div class="lg-mb-20px sm-mb-0">
                                <span>By <a href="blog-grid.html" class="text-dark-gray">Shane smith</a></span> on <a href="blog-grid.html" class="text-dark-gray">26 November 2021</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 sm-mb-30px">
                                <div class="border-radius-5px border-1 border border-color-light-medium-gray h-100 pt-8 pb-8 ps-10 pe-10 last-paragraph-no-margin">
                                    ...
                                    <p>Lorem ipsum is simply dummy text of the printing typesetting industry. Lorem ipsum been industry's standard dummy text scrambled.</p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="border-radius-5px border-1 border border-color-light-medium-gray h-100 pt-8 pb-8 ps-10 pe-10 last-paragraph-no-margin">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 position-relative">
                        ...
                        <a href="https://player.vimeo.com/video/75976293" class="text-center bg-white rounded-circle video-icon-box video-icon-extra-large popup-vimeo slide-up-animation absolute-middle-center">
                            <span>
