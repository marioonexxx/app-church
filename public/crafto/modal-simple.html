...
<html class="no-js" lang="en">
    ...
    <body data-mobile-nav-style="classic"> 
                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-12 col-xl-6 col-lg-8 text-center position-relative page-title-double-large">
                        <div class="d-flex flex-column justify-content-center extra-very-small-screen">
                            <h1 class="text-dark-gray alt-font ls-minus-1px fw-700 mb-20px">Modal simple</h1>
        ...
        <section class="bg-slate-blue big-section">
            <div class="container">  
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-12 col-xl-7 col-lg-8 col-md-10 text-center position-relative">
                        <span class="text-dark-gray fs-20 mb-15px d-inline-block">Rotate animation</span>
                        <h1 class="text-dark-gray mb-50px fw-600 ls-minus-2px w-90 mx-auto">Popup with rotate animation effect.</h1>
                        <a href="#modal-popup3" class="btn btn-extra-large btn-rounded with-rounded popup-with-move-anim btn-dark-gray btn-box-shadow text-transform-none">Open modal popup<span class="bg-white text-white"><i class="fa-solid fa-arrow-right text-dark-gray"></i></span></a>
                        <!-- start modal pop-up -->
                        <div id="modal-popup3" class="zoom-anim-dialog mfp-hide col-xl-3 col-lg-6 col-md-7 col-11 mx-auto bg-white text-center modal-popup-main p-50px">
                            ...
                            <p>Lorem ipsum is simply dummy text of the printing typesetting industry. Lorem ipsum has been the industry's standard dummy ever since.</p>
                            <a class="btn btn-small btn-rounded btn-dark-gray popup-modal-dismiss mt-10px" href="#">Dismiss</a>
                        </div> 
                        <!-- end modal pop-up --> 
                    </div> 
        ...
        <!-- end modal pop-up section -->
        <!-- start modal pop-up section -->
        <section class="big-section fix-background position-relative" style="background-image: url(https://placehold.co/1920x1080)">
            <div class="opacity-light bg-black"></div>
            <div class="container">
                <div class="row justify-content-center position-relative"> 
                    <div class="col-12 col-xl-10 col-md-10 text-center">
                        <span class="text-white fs-20 mb-15px d-inline-block">Slide up animation</span> 
                        <h2 class="text-white mb-50px fw-500 ls-minus-2px w-80 mx-auto">Make a more appealing with slide up animated popup.</h2>
                        <a href="#modal-popup4" class="btn btn-extra-large fw-700 btn-white btn-box-shadow text-transform-none btn-rounded btn-hover-animation-switch slide-up-animation">
                            <span>
                                <span class="btn-text">Open modal popup</span>
                                <span class="btn-icon"><i class="fa-solid fa-arrow-right"></i></span>
                                <span class="btn-icon"><i class="fa-solid fa-arrow-right"></i></span>
                            </span> 
                        </a>
                        <!-- start modal pop-up -->
                        <div id="modal-popup4" class="slide-up-popup mfp-hide col-xl-3 col-lg-6 col-md-7 col-11 mx-auto bg-white text-center modal-popup-main p-50px">
                            <span class="text-dark-gray fw-600 fs-24 mb-10px d-block">Slide up animation</span>
            ...
            <div class="container"> 
                <div class="row justify-content-center">
                    <div class="col-12 col-xl-10 text-center">
                        <span class="text-dark-gray fs-20 mb-15px d-inline-block">Zoom animation</span>
                        <h2 class="text-dark-gray mb-50px ls-minus-2px fw-600">It can be used to create a more interactive user experience.</h2>
                        <a class="btn btn-gradient-pink-orange btn-extra-large btn-box-shadow text-transform-none btn-rounded popup-with-zoom-anim" href="#modal-popup2">Open modal popup</a> 
                        <!-- start modal pop-up -->
                        <div id="modal-popup2" class="zoom-anim-dialog mfp-hide col-xl-3 col-lg-6 col-md-7 col-11 mx-auto bg-white text-center modal-popup-main p-50px">
                            <span class="text-dark-gray fw-600 fs-24 mb-10px d-block">Zoom animation</span>
                            <p>Lorem ipsum is simply dummy text of the printing typesetting industry. Lorem ipsum has been the industry's standard dummy ever since.</p>
                            <a class="btn btn-small btn-rounded btn-dark-gray popup-modal-dismiss mt-10px" href="#">Dismiss</a>
                        </div>
                        <!-- end modal pop-up -->
