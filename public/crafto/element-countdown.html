...
<html class="no-js" lang="en">
    ...
    <body data-mobile-nav-style="classic">
                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-12 col-xl-6 col-lg-8 text-center position-relative page-title-double-large">
                        <div class="d-flex flex-column justify-content-center extra-very-small-screen">
                            <h1 class="text-dark-gray alt-font ls-minus-1px fw-700 mb-20px">Countdown</h1>
                            <h2 class="text-dark-gray d-inline-block fw-400 ls-0px mb-0">Employ the countdown element to unveil an animated timer for your special day. Tailor date, colors, fonts effortlessly!</h2> 
                        </div>
        ...
        <!-- end page title -->
        <!-- start section -->
        <section class="cover-background" style="background-image: url(images/coming-soon-bg.jpg);">.
            ...
            <div class="container">
                ...
                <div class="row align-items-center justify-content-center h-100 z-index-2 position-relative">
                    <div class="col-md-10 col-lg-10 col-xl-6 text-center">
                        <span class="fw-700 fs-80 mb-20px d-block alt-font text-dark-gray ls-minus-2px">Coming soon!</span>
                        <h6 class="text-dark-gray mb-10 alt-font">We're getting ready to launch!</h6>
                        <div class="col d-flex justify-content-center countdown-style-01">
                            <div data-enddate="2024/10/01 12:00:00" class="countdown"></div>
                        </div>
                    </div>
                </div>
                <!-- end countdown item -->
            ...
            <div class="container">
                <div class="row align-items-center justify-content-center">
                    <div class="col-lg-10 text-center">
                        <div class="countdown-style-03">
                            <div data-enddate="2024/12/08 12:00:00" class="countdown"></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- end section -->
        <!-- start section -->
        <section class="fix-background big-section" style=" background-image: url('https://placehold.co/1920x1303');">
