...
<html class="no-js" lang="en">
    ...
    <body data-mobile-nav-style="classic"> 
        ...
        <header>
            <!-- start navigation -->
            <nav class="navbar navbar-expand-lg header-transparent bg-transparent header-reverse header-demo" data-header-hover="light">
                    ...
                    <div class="col-auto col-lg-2 text-end xs-pe-0"> 
                        <div class="header-icon">  
                            <div class="header-button">
                                <a href="https://1.envato.market/R53mL2" target="_blank" class="btn btn-white btn-small btn-switch-text btn-rounded text-transform-none btn-box-shadow purchase-envato">
                                    <span>
        ...
        <!-- end header -->
        <!-- start section --> 
        <section class="cover-background one-fifth-screen d-flex align-items-center" style="background-image: url(https://placehold.co/1920x1100)">
            <div class="opacity-light bg-gradient-dark-transparent"></div>
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-10 position-relative">
                        <div class="d-inline-block mb-20px text-white fs-18 opacity-6">
                            <a href="blog-grid.html" class="text-white">26 November 2023</a>
                            <span class="d-inline-block fs-30 opacity-5 align-middle ms-15px me-15px">•</span>
                            <a href="blog-grid.html" class="text-white">Fashion</a>
                        </div>
                        <h1 class="text-white w-60 lg-w-75 sm-w-100 alt-font fw-500 ls-minus-2px text-shadow-double-large mb-0">Nature always wears the colors of the spirit.</h1>
                        <div class="text-white fs-18 mt-40px">
                            <img class="w-80px h-80px rounded-circle me-15px" src="https://placehold.co/148x148" alt="">
                            <a href="blog-grid.html" class="text-white text-decoration-line-bottom">Shane smith</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-10 mb-6 sm-mb-35px last-paragraph-no-margin text-center">
                        <img src="https://placehold.co/987x550" class="mb-20px" alt="">
                        <p class="pb-20px alt-font fs-14 text-uppercase ls-1px">Photography by Richard winters</p>
                    ...
                    <div class="col-lg-10 last-paragraph-no-margin">
                        <h5 class="fw-500 text-dark-gray w-90 md-w-100">We finished our first sensor sweep of the neutral zone. Fashion you can buy but style you possess.</h5>
                        ...
                        <h5 class="fw-500 text-dark-gray w-90 md-w-100">Fashion is what you're offered four times a year by designers and style is what you choose.</h5>
