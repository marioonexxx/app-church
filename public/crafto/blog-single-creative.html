...
<html class="no-js" lang="en">
    ...
    <body data-mobile-nav-style="classic"> 
        ...
        <header>
            <!-- start navigation -->
            <nav class="navbar navbar-expand-lg header-light header-reverse header-demo border-bottom border-color-extra-medium-gray" data-header-hover="light">
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-10 text-center">
                        <span class="fs-18 mb-30px d-inline-block sm-mb-20px">By <a href="#" class="text-dark-gray text-decoration-line-bottom">Jackson</a> in <a href="#" class="text-dark-gray text-decoration-line-bottom">Marketing</a> on 26 November 2021</span>
        ...
        <section class="py-0 ps-13 pe-13 lg-ps-4 lg-pe-4 sm-px-0">
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-12"><img src="https://placehold.co/1410x850" class="w-100" alt=""></div>
                </div>
            </div>
        </section>
        <!-- end section -->
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-4 text-center sm-mb-30px">
                                <div class="pb-20px">
                                    ...
                                    <a href="blog-grid.html" class="text-dark-gray alt-font fw-500 text-uppercase">Jackson smith</a>
                                </div>
        ...
        <section>
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-10">
                        <div class="row">
                            <div class="col-lg-3 col-md-4 text-center text-lg-end sm-mb-30px"><img src="images/blog-single-creative-05.png" class="mt-10px" alt=""></div>
                            <div class="offset-lg-1 col-md-8 last-paragraph-no-margin text-center text-md-start">
        ...
        <section class="py-0 ps-13 pe-13 lg-ps-4 lg-pe-4 sm-px-0">
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-12"><img src="https://placehold.co/1410x659" class="w-100" alt=""></div>
                </div>
            </div>
        </section>
        <!-- end section -->
                        ...
                        <ul class="blog-grid blog-wrapper grid-loading grid grid-3col xl-grid-3col lg-grid-3col md-grid-2col sm-grid-2col xs-grid-1col gutter-double-extra-large">
                            ...
                            <li class="grid-item">
                                <div class="card border-0 border-radius-4px box-shadow-medium box-shadow-extra-large-hover">
                                    <div class="blog-image">
                                        <a href="#" class="d-block"><img src="https://placehold.co/800x570" alt="" /></a>
                                    ...
                                    <div class="card-body p-13 md-p-11">
                                        <a href="#" class="card-title mb-15px alt-font fw-500 lh-28 text-dark-gray d-inline-block">How to bring the season into your great marketing</a>
                            ...
                            <li class="grid-item">
                                <div class="card border-0 border-radius-4px box-shadow-medium box-shadow-extra-large-hover">
                                    ...
                                    <div class="card-body p-13 md-p-11">
                                        <a href="#" class="card-title mb-15px alt-font fw-500 lh-28 text-dark-gray d-inline-block">Build up healthy habits and strong peaceful life</a>
                                        <p>Lorem ipsum has been industry standard dummy text ever...</p>
                                        <div class="author d-flex justify-content-center align-items-center position-relative overflow-hidden fs-14 text-uppercase">
                                            <div class="me-auto">
                            ...
                            <li class="grid-item">
                                <div class="card border-0 border-radius-4px box-shadow-medium box-shadow-extra-large-hover">
                                    ...
                                    <div class="card-body p-13 md-p-11">
                                        <a href="#" class="card-title mb-15px alt-font fw-500 lh-28 text-dark-gray d-inline-block">Make business easy with beautiful application</a>
                                        <p>Lorem ipsum has been industry standard dummy text ever...</p>
                                        <div class="author d-flex justify-content-center align-items-center position-relative overflow-hidden fs-14 text-uppercase">
                                            <div class="me-auto">
