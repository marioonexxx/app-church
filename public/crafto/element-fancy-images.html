...
<html class="no-js" lang="en">
    ...
    <body data-mobile-nav-style="classic">
        ...
        <header>
            <!-- start navigation -->
            <nav class="navbar navbar-expand-lg bg-transparent header-transparent disable-fixed header-demo" data-header-hover="light">
                    ...
                    <div class="col-auto col-lg-2 text-end xs-pe-0"> 
                        <div class="header-icon">  
                            <div class="header-button">
                                <a href="https://1.envato.market/R53mL2" target="_blank" class="btn btn-white fw-700 btn-small btn-switch-text btn-rounded text-transform-none btn-box-shadow purchase-envato">
                                    <span>
        ...
        <div class="page-content position-relative">
            <!-- start section --> 
            <section class="p-0 ipad-top-space-margin full-screen sm-h-500px position-relative overflow-hidden bg-extra-dark-slate-blue magic-cursor round-cursor" data-background="#ffffff" style="background-image: url(images/vertical-line-bg-small-light-gray.svg)">
                <div class="container h-100">
                    <div class="row align-items-center justify-content-center position-relative h-100">
                        <div class="col-md-12 text-center">
                            <div class="text-white fs-250 xl-fs-200 lg-fs-160 xs-fs-90 fw-600 ls-minus-10px xs-ls-minus-2px fancy-text-style-4 z-index-1 position-relative text-sm-nowrap text-shadow-double-large">cascading</div>
                        </div> 
                        <div class="position-absolute absolute-middle-center text-center p-10 lg-pt-15 md-p-15px">
                            <div class="overflow-hidden position-relative">
                                <div class="w-100" data-anime='{ "effect": "slide", "direction": "lr", "color": "#2d663c", "duration": 1000, "delay": 0 }'>
                                    <img src="https://placehold.co/1200x800" alt="" class="w-100 liquid-parallax" data-parallax-liquid="true" data-parallax-position="top" data-parallax-scale="1.1" data-parallax-scale-fraction="0.005">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-9 position-relative">
                            <div class="row align-items-center position-relative md-mb-10 sm-mb-0 g-0" data-anime='{ "opacity": [0,1], "duration": 600, "delay":0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                                ...
                                <div class="col-md-6 offset-md-1 sm-mb-30px text-end" data-shadow-animation="true" data-animation-delay="200" data-bottom-top="transform: translateY(-30px)" data-top-bottom="transform: translateY(30px)">
                                    <img src="https://placehold.co/600x600" alt="" class="box-shadow-quadruple-large w-100" />
                                </div>
            ...
            <!-- end section -->
            <!-- start section --> 
            <section class="overflow-hidden position-relative pb-0" data-background="#000000">
                <div class="container-fluid p-0 h-100 position-relative">
                    <div class="row g-0 align-items-center justify-content-center text-center">
                        <div class="col-md-12 position-relative">
                            <img src="https://placehold.co/1920x1303" alt="" class="w-100" data-bottom-top="transform: scale(1)" data-top-bottom="transform: scale(0.6)" />
                        </div> 
                        <div class="absolute-middle-center z-index-99">
                            <div class="swiper swiper-width-auto text-center pb-20px" data-slider-options='{ "slidesPerView": "auto", "spaceBetween":40, "centeredSlides": true, "speed": 15000, "loop": true, "pagination": { "el": ".slider-four-slide-pagination-2", "clickable": false }, "allowTouchMove": false, "autoplay": { "delay":1, "disableOnInteraction": false }, "navigation": { "nextEl": ".slider-four-slide-next-2", "prevEl": ".slider-four-slide-prev-2" }, "keyboard": { "enabled": true, "onlyInViewport": true }, "effect": "slide" }'>
                                <div class="swiper-wrapper marquee-slide">
                                    <!-- start client item -->
                                    <div class="swiper-slide">
                                        <div class="fs-180 xl-fs-120 sm-fs-80 text-white fw-600 ls-minus-8px sm-ls-minus-4px word-break-normal">branding.</div>
                                    </div>
                                    <!-- end client item -->
                                    <!-- start client item -->
                                    <div class="swiper-slide">
                                        <div class="fs-180 xl-fs-120 sm-fs-80 text-white fw-600 ls-minus-8px sm-ls-minus-4px word-break-normal">graphic.</div>
                                    </div>
                                    <!-- end client item --> 
                                    <!-- end client item --> 
                                    <!-- start client item -->
                                    <div class="swiper-slide">
                                        <div class="fs-180 xl-fs-120 sm-fs-80 text-white fw-600 ls-minus-8px sm-ls-minus-4px word-break-normal">print.</div>
                                    </div>
                                    <!-- end client item --> 
                                    <!-- start client item -->
                                    <div class="swiper-slide">
                                        <div class="fs-180 xl-fs-120 sm-fs-80 text-white fw-600 ls-minus-8px sm-ls-minus-4px word-break-normal">illustration.</div>
                                    </div>
                                    <!-- end client item --> 
                                    <!-- start client item -->
                                    <div class="swiper-slide">
                                        <div class="fs-180 xl-fs-120 sm-fs-80 text-white fw-600 ls-minus-8px sm-ls-minus-4px word-break-normal">packaging.</div>
                                    </div>
                                    <!-- end client item --> 
                                    <!-- start client item -->
                                    <div class="swiper-slide">
                                        <div class="fs-180 xl-fs-120 sm-fs-80 text-white fw-600 ls-minus-8px sm-ls-minus-4px word-break-normal">web.</div>
                                    </div>
                                    <!-- end client item -->   
                                </div> 
                            </div>  
            ...
            <!-- end section -->
            <!-- start section --> 
            <section class="pt-xl-0" data-background="#ffffff">
                <div class="container">
                    <div class="row align-items-center justify-content-center text-center mb-3">
                        <div class="col-md-12">
                            <h2 class="text-black fw-600 fs-60 ls-minus-2px">Reveal effects</h2>
                        </div> 
                    </div>
                    <div class="row row-cols-1 row-cols-lg-4 row-cols-sm-2">
                        <div class="col lg-mb-30px" data-bottom-top="transform: translateY(30px)" data-top-bottom="transform: translateY(-30px)">
                            <div class="overflow-hidden position-relative">
                                <div class="w-100 border-radius-8px overflow-hidden" data-anime='{ "effect": "slide", "direction": "lr", "color": "#507590", "duration": 1000, "delay": 500 }'>
                                    <img src="https://placehold.co/410x505" class="w-100" alt=""/>
                                </div>
                            </div>
                        </div>
                        <div class="col lg-mb-30px" data-bottom-top="transform: translateY(-30px)" data-top-bottom="transform: translateY(30px)">
                            <div class="overflow-hidden position-relative">
                                <div class="w-100 border-radius-8px overflow-hidden" data-anime='{ "effect": "slide", "direction": "rl", "color": "#b25d40", "duration": 1000, "delay": 1000 }'>
                                    <img src="https://placehold.co/410x505" class="w-100" alt=""/>
                                </div>
                            </div>
                        </div>
                        <div class="col xs-mb-30px">
                            <div class="overflow-hidden position-relative" data-bottom-top="transform: translateY(30px)" data-top-bottom="transform: translateY(-30px)">
                                <div class="w-100 border-radius-8px overflow-hidden" data-anime='{ "effect": "slide", "direction": "tb", "color": "#ae733a", "duration": 1000, "delay": 1500 }'>
                                    <img src="https://placehold.co/410x505" class="w-100" alt=""/>
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="overflow-hidden position-relative" data-bottom-top="transform: translateY(-30px)" data-top-bottom="transform: translateY(30px)">
                                <div class="w-100 border-radius-8px overflow-hidden" data-anime='{ "effect": "slide", "direction": "bt", "color": "#518d51", "duration": 1000, "delay": 2000 }'>
                                    <img src="https://placehold.co/410x505" class="w-100" alt=""/>
                                </div>
                            </div>
                        </div>
            ...
            <!-- end section -->
            <!-- start section --> 
            <section class="position-relative big-section" data-background="#000000">
                <div class="absolute-bottom-center left-0px z-index-1 d-none d-md-inline-block">
                    <img class="animation-float lg-w-250px" src="images/demo-vertical-portfolio-bg-01.png" alt="">
                </div>
                <div class="absolute-middle-right right-50px lg-right-0px top-150px md-top-100px z-index-1 d-none d-md-inline-block">
                    <img class="animation-float" src="images/demo-vertical-portfolio-bg-02.png" alt="">
                </div>
                <div class="container">
                    <div class="row align-items-center justify-content-center text-center mb-3">
                        <div class="col-md-12">
                            <h2 class="text-white fw-600 fs-60 ls-minus-2px">Tilt effects</h2>
                        </div> 
                    </div>
                    <div class="row align-items-center justify-content-center">
                        <div class="col-sm-10 position-relative" data-anime='{ "scale":[1.2,1], "opacity": [0,1], "duration": 500, "delay": 0, "staggervalue": 200, "easing": "easeOutQuad" }'>
                            <div class="atropos" data-atropos data-atropos-perspective="1450">
                                <div class="atropos-scale">
                                    <div class="atropos-rotate">
                                        <div class="atropos-inner" data-atropos-offset="3">
                                            <img class="w-100 border-radius-8px" src="https://placehold.co/1920x1303" alt="" />
                                        </div>
                                    </div> 
                                </div>
                            </div>
