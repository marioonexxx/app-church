            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xxl-6 col-lg-9 d-flex flex-column justify-content-center full-screen md-h-600px sm-h-500px">
                        <div class="ps-15 pe-15 lg-ps-8 lg-pe-8 sm-px-0">
                            <span class="alt-font ls-minus-05px fs-20 text-dark-gray mb-5 d-inline-block">Posted by <a href="blog-grid.html" class="text-dark-gray text-dark-gray-hover fw-600 text-decoration-line-bottom">colene landin</a></span>
                            <h1 class="alt-font text-dark-gray fw-600 mb-8 ls-minus-2px">Every time we launch a feature people yell at us.</h1>
                            <a href="blog-grid.html" class="btn btn-dark-gray btn-medium">Interior design</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8 last-paragraph-no-margin">
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent ullamcorper ex nunc, in fringilla orci fringilla sed. Nam semper odio eu urna viverra, eu luctus mauris sollicitudin. Morbi ultricies est et odio vehicula, vel lacinia ipsum ullamcorper. Mauris mattis placerat quam, aliquam vestibulum dui bibendum eu. Curabitur eu euismod ex, et hendrerit purus. Donec condimentum vel neque id iaculis. Etiam dui id dolor lobortis cursus ac maximus nisl. In sodales lacus nec cursus varius. Nulla est quam, volutpat non rhoncus non.</p>
                    </div>
                </div>
            </div>
        </section>
