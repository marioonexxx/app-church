                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-lg-8 blog-standard md-mb-50px sm-mb-40px">
                        ...
                        <div class="col-12 blog-details mb-12"> 
                            ...
                            <h5 class="text-dark-gray fw-600 w-80 sm-w-100 mb-6">The best way to get started is to quit talking and begin doing.</h5>
                            <div class="mb-6">
                                <iframe class="h-400px w-100" style="border: 0;" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/3005344&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false&amp;visual=true"></iframe>
                            </div>
                            ...
                            <img src="https://placehold.co/800x570" alt="" class="w-100 border-radius-6px mb-7">
                                ...
                                <div class="col-12 mb-7">
                                    <div class="d-block d-md-flex w-100 box-shadow-extra-large align-items-center border-radius-4px p-8">
                                        <div class="w-140px text-center me-60px sm-mx-auto">
                                            <img src="https://placehold.co/125x125" class="rounded-circle w-110px" alt="">
                    ...
                    <aside class="col-12 col-xl-4 col-lg-4 col-md-7 ps-55px xl-ps-50px lg-ps-15px sidebar">
                        <div class="mb-15 md-mb-50px xs-mb-35px">
                            ...
                            <ul class="popular-post-sidebar position-relative">
                                <li class="d-flex align-items-center">
                                    <figure>
                                        <a href="demo-elearning-blog-single-simple.html"><img src="https://placehold.co/600x600" alt=""></a>
                                    </figure>
                        ...
                        <div class="mb-15 md-mb-50px xs-mb-35px">
                            ...
                            <ul class="category-list-sidebar position-relative">
                                <li class="d-flex align-items-center h-80px cover-background ps-35px pe-35px" style="background-image: url('https://placehold.co/600x144')">
